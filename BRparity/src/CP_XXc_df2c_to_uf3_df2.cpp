...
complex_t CP_XXc_df2c_to_uf3_df2(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0001 = std::conj(lpp_201)*std::conj(U_dtR_00);
    const complex_t IT_0002 = std::conj(lpp_210)*std::conj(U_dtR_00);
    const complex_t IT_0003 = std::conj(lpp_212)*std::conj(U_dtR_20);
    const complex_t IT_0004 = std::conj(lpp_221)*std::conj(U_dtR_20);
    const complex_t IT_0005 = (complex_t{0, 1})*(IT_0001 + -IT_0002 + -IT_0003
       + IT_0004);
    const complex_t IT_0006 = (complex_t{0, -1})*gw*gwdR*U_dtR_10;
    ...
    const complex_t IT_0034 = std::pow(m_t, 2);
    ...
    const complex_t IT_0042 = (-2)*IT_0000;
    ...
    const complex_t IT_0048 = 0.25*IT_0036 + 0.25*IT_0038 + 0.25*IT_0040;
    const complex_t IT_0049 = IT_0048*std::conj(IT_0048);
    return 2*IT_0000*(IT_0033*std::conj(IT_0033) + IT_0041*std::conj(IT_0041))
       + (std::conj(IT_0033)*IT_0041 + IT_0033*std::conj(IT_0041))*IT_0042 + 2
      *IT_0047*IT_0049;
}
