        ...
        )
{
    ...
    const complex_t IT_0001 = lpp_020*U_utR_00;
    const complex_t IT_0002 = lpp_120*U_utR_10;
    const complex_t IT_0003 = lpp_220*U_utR_20;
    const complex_t IT_0004 = IT_0001 + IT_0002 + IT_0003;
    const complex_t IT_0005 = lpp_002*U_utR_00;
    const complex_t IT_0006 = lpp_102*U_utR_10;
    const complex_t IT_0007 = lpp_202*U_utR_20;
    ...
    const complex_t IT_0019 = lpp_020*U_utR_01;
    const complex_t IT_0020 = lpp_120*U_utR_11;
    const complex_t IT_0021 = lpp_220*U_utR_21;
    const complex_t IT_0022 = IT_0019 + IT_0020 + IT_0021;
    const complex_t IT_0023 = lpp_002*U_utR_01;
    const complex_t IT_0024 = lpp_102*U_utR_11;
    const complex_t IT_0025 = lpp_202*U_utR_21;
    ...
    const complex_t IT_0038 = lpp_002*U_utR_02;
    const complex_t IT_0039 = lpp_102*U_utR_12;
    const complex_t IT_0040 = lpp_202*U_utR_22;
    ...
    const complex_t IT_0094 = lpp_001*U_dtR_10;
    const complex_t IT_0095 = lpp_002*U_dtR_20;
    const complex_t IT_0096 = IT_0094 + IT_0095;
    const complex_t IT_0097 = lpp_010*U_dtR_10;
    const complex_t IT_0098 = lpp_020*U_dtR_20;
    ...
    const complex_t IT_0106 = lpp_001*U_dtR_11;
    const complex_t IT_0107 = lpp_002*U_dtR_21;
    const complex_t IT_0108 = IT_0106 + IT_0107;
    const complex_t IT_0109 = lpp_010*U_dtR_11;
    const complex_t IT_0110 = lpp_020*U_dtR_21;
    ...
    const complex_t IT_0117 = lpp_001*U_dtR_12;
    const complex_t IT_0118 = lpp_002*U_dtR_22;
    const complex_t IT_0119 = IT_0117 + IT_0118;
    const complex_t IT_0120 = lpp_010*U_dtR_12;
    const complex_t IT_0121 = lpp_020*U_dtR_22;
