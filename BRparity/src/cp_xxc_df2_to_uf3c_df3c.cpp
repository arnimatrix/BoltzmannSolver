        ...
        )
{
    ...
    const complex_t IT_0056 = lpp_220*U_dtR_01;
    const complex_t IT_0057 = lpp_221*U_dtR_11;
    ...
    const complex_t IT_0064 = lpp_202*U_dtR_02;
    const complex_t IT_0065 = lpp_212*U_dtR_12;
    const complex_t IT_0066 = IT_0064 + IT_0065;
    const complex_t IT_0067 = lpp_220*U_dtR_02;
    const complex_t IT_0068 = lpp_221*U_dtR_12;
    ...
    const complex_t IT_0079 = IT_0040 + IT_0078;
    const complex_t IT_0080 = IT_0076 + IT_0079;
    ...
    const complex_t IT_0128 = -IT_0076;
    ...
    const complex_t IT_0131 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + (-0.5)
      *std::conj(IT_0075)*IT_0080 + (-0.5)*std::conj(IT_0127)*(IT_0040 + IT_0077
       + IT_0128)) + 2*IT_0075*(std::conj(IT_0075)*IT_0076 + 0.5*std::conj
      (IT_0127)*IT_0129 + 0.5*IT_0080*IT_0130) + 2*IT_0127*(IT_0077*std::conj
      (IT_0127) + 0.5*std::conj(IT_0075)*IT_0129 + 0.5*(IT_0040 + IT_0077 +
       IT_0128)*IT_0130);
    return IT_0131;
}
