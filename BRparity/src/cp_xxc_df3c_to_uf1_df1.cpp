        ...
        )
{
    ...
    const complex_t IT_0000 = std::conj(lpp_001)*std::conj(U_dtR_10);
    const complex_t IT_0001 = std::conj(lpp_002)*std::conj(U_dtR_20);
    const complex_t IT_0002 = IT_0000 + IT_0001;
    const complex_t IT_0003 = std::conj(lpp_010)*std::conj(U_dtR_10);
    const complex_t IT_0004 = std::conj(lpp_020)*std::conj(U_dtR_20);
    const complex_t IT_0005 = -IT_0003 + -IT_0004;
    const complex_t IT_0006 = IT_0002 + IT_0005;
    const complex_t IT_0007 = gw*gwdR*U_dtR_20;
    ...
    const complex_t IT_0015 = std::conj(lpp_001)*std::conj(U_dtR_11);
    const complex_t IT_0016 = std::conj(lpp_002)*std::conj(U_dtR_21);
    const complex_t IT_0017 = IT_0015 + IT_0016;
    const complex_t IT_0018 = std::conj(lpp_010)*std::conj(U_dtR_11);
    const complex_t IT_0019 = std::conj(lpp_020)*std::conj(U_dtR_21);
    const complex_t IT_0020 = -IT_0018 + -IT_0019;
    const complex_t IT_0021 = IT_0017 + IT_0020;
    const complex_t IT_0022 = gw*gwdR*U_dtR_21;
    ...
    const complex_t IT_0027 = std::conj(lpp_001)*std::conj(U_dtR_12);
    const complex_t IT_0028 = std::conj(lpp_002)*std::conj(U_dtR_22);
    const complex_t IT_0029 = IT_0027 + IT_0028;
    const complex_t IT_0030 = std::conj(lpp_010)*std::conj(U_dtR_12);
    const complex_t IT_0031 = std::conj(lpp_020)*std::conj(U_dtR_22);
    const complex_t IT_0032 = -IT_0030 + -IT_0031;
    const complex_t IT_0033 = IT_0029 + IT_0032;
    const complex_t IT_0034 = gw*gwdR*U_dtR_22;
    ...
    const complex_t IT_0041 = std::conj(lpp_002)*std::conj(U_dtR_00);
    const complex_t IT_0042 = std::conj(lpp_012)*std::conj(U_dtR_10);
    const complex_t IT_0043 = IT_0041 + IT_0042;
    const complex_t IT_0044 = std::conj(lpp_020)*std::conj(U_dtR_00);
    const complex_t IT_0045 = std::conj(lpp_021)*std::conj(U_dtR_10);
    const complex_t IT_0046 = -IT_0044 + -IT_0045;
    const complex_t IT_0047 = IT_0043 + IT_0046;
    const complex_t IT_0048 = gw*gwdR*U_dtR_00;
    const complex_t IT_0049 = IT_0047*IT_0048;
    const complex_t IT_0050 = std::pow(m_d, 2);
    ...
    const complex_t IT_0053 = std::conj(lpp_002)*std::conj(U_dtR_01);
    const complex_t IT_0054 = std::conj(lpp_012)*std::conj(U_dtR_11);
    const complex_t IT_0055 = IT_0053 + IT_0054;
    const complex_t IT_0056 = std::conj(lpp_020)*std::conj(U_dtR_01);
    const complex_t IT_0057 = std::conj(lpp_021)*std::conj(U_dtR_11);
    const complex_t IT_0058 = -IT_0056 + -IT_0057;
    const complex_t IT_0059 = IT_0055 + IT_0058;
    const complex_t IT_0060 = gw*gwdR*U_dtR_01;
    ...
    const complex_t IT_0064 = std::conj(lpp_002)*std::conj(U_dtR_02);
    const complex_t IT_0065 = std::conj(lpp_012)*std::conj(U_dtR_12);
    const complex_t IT_0066 = IT_0064 + IT_0065;
    const complex_t IT_0067 = std::conj(lpp_020)*std::conj(U_dtR_02);
    const complex_t IT_0068 = std::conj(lpp_021)*std::conj(U_dtR_12);
    const complex_t IT_0069 = -IT_0067 + -IT_0068;
    const complex_t IT_0070 = IT_0066 + IT_0069;
    const complex_t IT_0071 = gw*gwdR*U_dtR_02;
    ...
    const complex_t IT_0092 = gw*gwuR*U_utR_00;
    ...
    const complex_t IT_0108 = gw*gwuR*U_utR_01;
    ...
    const complex_t IT_0123 = gw*gwuR*U_utR_02;
    ...
    const complex_t IT_0130 = IT_0076 + IT_0077 + IT_0080;
    ...
    const complex_t IT_0133 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + 0.5
      *std::conj(IT_0075)*IT_0081 + 0.5*std::conj(IT_0128)*IT_0129) + 2*IT_0075*
