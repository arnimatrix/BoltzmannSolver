        ...
        )
{
    ...
    const complex_t IT_0000 = lpp_021*U_utR_02;
    const complex_t IT_0001 = lpp_121*U_utR_12;
    const complex_t IT_0002 = lpp_221*U_utR_22;
    const complex_t IT_0003 = IT_0000 + IT_0001 + IT_0002;
    const complex_t IT_0004 = lpp_012*U_utR_02;
    const complex_t IT_0005 = lpp_112*U_utR_12;
    const complex_t IT_0006 = lpp_212*U_utR_22;
