...
complex_t CP_XXc_uf2c_to_df3_df1(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0008 = std::pow(m_c, 2);
    ...
    const complex_t IT_0012 = std::conj(lpp_102)*std::conj(U_dtR_01);
    const complex_t IT_0013 = std::conj(lpp_112)*std::conj(U_dtR_11);
    const complex_t IT_0014 = std::conj(lpp_120)*std::conj(U_dtR_01);
    const complex_t IT_0015 = std::conj(lpp_121)*std::conj(U_dtR_11);
    ...
    const complex_t IT_0022 = std::conj(lpp_102)*std::conj(U_dtR_02);
    const complex_t IT_0023 = std::conj(lpp_112)*std::conj(U_dtR_12);
    const complex_t IT_0024 = std::conj(lpp_120)*std::conj(U_dtR_02);
    const complex_t IT_0025 = std::conj(lpp_121)*std::conj(U_dtR_12);
    ...
    const complex_t IT_0040 = (complex_t{0, -1})*gw*gwuR*U_utR_10;
    const complex_t IT_0041 = IT_0039*IT_0040;
    const complex_t IT_0042 = std::pow(m_XX, 2);
    const complex_t IT_0043 = std::pow(m_utR1, 2);
    const complex_t IT_0044 = std::pow(2*s_12 + (complex_t{0, 1})*GuRt*m_utR1 
      + IT_0008 + IT_0042 + -IT_0043 + reg_prop, -1);
    ...
    const complex_t IT_0053 = (complex_t{0, -1})*gw*gwuR*U_utR_11;
    const complex_t IT_0054 = IT_0052*IT_0053;
    const complex_t IT_0055 = std::pow(m_utR2, 2);
    const complex_t IT_0056 = std::pow(2*s_12 + (complex_t{0, 1})*GcRt*m_utR2 
      + IT_0008 + IT_0042 + -IT_0055 + reg_prop, -1);
    ...
    const complex_t IT_0065 = (complex_t{0, -1})*gw*gwuR*U_utR_12;
    const complex_t IT_0066 = IT_0064*IT_0065;
    const complex_t IT_0067 = std::pow(m_utR3, 2);
    const complex_t IT_0068 = std::pow(2*s_12 + (complex_t{0, 1})*GtRt*m_utR3 
      + IT_0008 + IT_0042 + -IT_0067 + reg_prop, -1);
    const complex_t IT_0069 = (complex_t{0, 1})*IT_0066*IT_0068;
    const complex_t IT_0070 = IT_0045 + IT_0057 + IT_0069;
    const complex_t IT_0071 = std::conj(lpp_101)*std::conj(U_dtR_10);
    const complex_t IT_0072 = std::conj(lpp_102)*std::conj(U_dtR_20);
    const complex_t IT_0073 = std::conj(lpp_110)*std::conj(U_dtR_10);
    const complex_t IT_0074 = std::conj(lpp_120)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0078 = std::pow((-2)*s_13 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0007 + -IT_0009 + IT_0042 + reg_prop, -1);
    const complex_t IT_0079 = (complex_t{0, 1})*IT_0077*IT_0078;
    const complex_t IT_0080 = std::conj(lpp_101)*std::conj(U_dtR_11);
    const complex_t IT_0081 = std::conj(lpp_102)*std::conj(U_dtR_21);
    const complex_t IT_0082 = std::conj(lpp_110)*std::conj(U_dtR_11);
    const complex_t IT_0083 = std::conj(lpp_120)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0087 = std::pow((-2)*s_13 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0007 + -IT_0019 + IT_0042 + reg_prop, -1);
    const complex_t IT_0088 = (complex_t{0, 1})*IT_0086*IT_0087;
    const complex_t IT_0089 = std::conj(lpp_101)*std::conj(U_dtR_12);
    const complex_t IT_0090 = std::conj(lpp_102)*std::conj(U_dtR_22);
    const complex_t IT_0091 = std::conj(lpp_110)*std::conj(U_dtR_12);
    const complex_t IT_0092 = std::conj(lpp_120)*std::conj(U_dtR_22);
    ...
    const complex_t IT_0096 = std::pow((-2)*s_13 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0007 + -IT_0029 + IT_0042 + reg_prop, -1);
    const complex_t IT_0097 = (complex_t{0, 1})*IT_0095*IT_0096;
    const complex_t IT_0098 = 0.5*IT_0079 + 0.5*IT_0088 + 0.5*IT_0097;
    ...
    const complex_t IT_0113 = 0.25*IT_0011 + 0.25*IT_0021 + 0.25*IT_0031;
    const complex_t IT_0103 = s_13*s_24;
    const complex_t IT_0104 = 128*IT_0103;
    const complex_t IT_0105 = s_14*s_23;
    const complex_t IT_0106 = 128*IT_0105;
    const complex_t IT_0107 = (-64)*IT_0100;
    const complex_t IT_0108 = IT_0104 + IT_0106 + IT_0107;
    const complex_t IT_0109 = m_b*m_c*m_d*m_XX;
    const complex_t IT_0110 = (-192)*IT_0109;
    const complex_t IT_0111 = IT_0108 + IT_0110;
    const complex_t IT_0112 = 192*IT_0109;
    const complex_t IT_0102 = (-0.25)*IT_0079 + (-0.25)*IT_0088 + (-0.25)
      *IT_0097;
    const complex_t IT_0118 = 64*IT_0100;
    const complex_t IT_0114 = m_b*m_d*s_12;
    const complex_t IT_0115 = m_c*m_XX*s_34;
    const complex_t IT_0116 = 96*IT_0115;
    const complex_t IT_0117 = (-64)*IT_0105;
    const complex_t IT_0119 = IT_0112 + 96*IT_0114 + IT_0116 + IT_0117 +
       IT_0118;
    const complex_t IT_0120 = (-128)*IT_0103;
    const complex_t IT_0121 = (-2)*IT_0100;
    const complex_t IT_0122 = (IT_0032*std::conj(IT_0032) + (IT_0070 + IT_0098
      )*IT_0099)*IT_0101 + std::conj(IT_0113)*((IT_0108 + IT_0111 + IT_0112)
      *IT_0113 + IT_0102*((-128)*IT_0105 + IT_0110 + IT_0118 + IT_0119 + IT_0120
      )) + std::conj(IT_0102)*(IT_0102*(IT_0108 + IT_0111 + IT_0112) + IT_0113*(
      (-128)*IT_0105 + IT_0110 + IT_0118 + IT_0119 + IT_0120)) + (std::conj
      (IT_0032)*(IT_0070 + IT_0098) + IT_0032*IT_0099)*IT_0121;
    return IT_0122;
}
