...
complex_t CP_XXc_df3_to_uf3c_df2c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0089 = -IT_0040;
    const complex_t IT_0090 = IT_0088 + IT_0089;
    const complex_t IT_0091 = s_24*s_35;
    ...
    const complex_t IT_0129 = IT_0090 + IT_0091;
    const complex_t IT_0130 = (-0.5)*std::conj(IT_0039);
    const complex_t IT_0131 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + (-0.5)
      *std::conj(IT_0087)*IT_0093 + (-0.5)*(IT_0040 + IT_0088 + IT_0092)
      *std::conj(IT_0128)) + 2*IT_0128*(IT_0088*std::conj(IT_0128) + 0.5
      *std::conj(IT_0087)*IT_0129 + (IT_0040 + IT_0088 + IT_0092)*IT_0130) + 2
      *IT_0087*(std::conj(IT_0087)*IT_0091 + 0.5*std::conj(IT_0128)*IT_0129 +
       IT_0093*IT_0130);
    return IT_0131;
}
