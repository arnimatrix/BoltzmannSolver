        ...
        )
{
    ...
    const complex_t IT_0051 = std::conj(IT_0048)*IT_0050;
    const complex_t IT_0052 = m_t*m_XX*IT_0007;
    const complex_t IT_0053 = 128*IT_0044;
    const complex_t IT_0054 = (-64)*IT_0033;
    ...
    const complex_t IT_0056 = 2*IT_0032*(std::conj(IT_0032)*IT_0033 + 0.5*
      ...
      *IT_0049 + 0.5*(std::conj(IT_0041) + std::conj(IT_0042))*IT_0050) +
       IT_0041*(IT_0051 + std::conj(IT_0041)*(128*IT_0043 + 192*IT_0052 +
       IT_0053 + IT_0054) + IT_0055) + IT_0042*(IT_0051 + std::conj(IT_0042)*
      (128*IT_0043 + (-192)*IT_0052 + IT_0053 + IT_0054) + IT_0055);
    return IT_0056;
}
