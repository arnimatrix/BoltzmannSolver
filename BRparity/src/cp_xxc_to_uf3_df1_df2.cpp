        ...
        )
{
    ...
    const complex_t IT_0004 = std::conj(lpp_010)*std::conj(U_utR_00);
    const complex_t IT_0005 = std::conj(lpp_110)*std::conj(U_utR_10);
    const complex_t IT_0006 = std::conj(lpp_210)*std::conj(U_utR_20);
    const complex_t IT_0007 = IT_0004 + IT_0005 + IT_0006;
    const complex_t IT_0008 = -IT_0007;
    const complex_t IT_0009 = IT_0003 + IT_0008;
    const complex_t IT_0010 = gw*gwuR*U_utR_20;
    ...
    const complex_t IT_0018 = std::conj(lpp_001)*std::conj(U_utR_01);
    const complex_t IT_0019 = std::conj(lpp_101)*std::conj(U_utR_11);
    const complex_t IT_0020 = std::conj(lpp_201)*std::conj(U_utR_21);
    const complex_t IT_0021 = IT_0018 + IT_0019 + IT_0020;
    const complex_t IT_0022 = std::conj(lpp_010)*std::conj(U_utR_01);
    const complex_t IT_0023 = std::conj(lpp_110)*std::conj(U_utR_11);
    const complex_t IT_0024 = std::conj(lpp_210)*std::conj(U_utR_21);
    const complex_t IT_0025 = IT_0022 + IT_0023 + IT_0024;
    const complex_t IT_0026 = -IT_0025;
    const complex_t IT_0027 = IT_0021 + IT_0026;
    const complex_t IT_0028 = gw*gwuR*U_utR_21;
    ...
    const complex_t IT_0033 = std::conj(lpp_001)*std::conj(U_utR_02);
    const complex_t IT_0034 = std::conj(lpp_101)*std::conj(U_utR_12);
    const complex_t IT_0035 = std::conj(lpp_201)*std::conj(U_utR_22);
    const complex_t IT_0036 = IT_0033 + IT_0034 + IT_0035;
    const complex_t IT_0037 = std::conj(lpp_010)*std::conj(U_utR_02);
    const complex_t IT_0038 = std::conj(lpp_110)*std::conj(U_utR_12);
    const complex_t IT_0039 = std::conj(lpp_210)*std::conj(U_utR_22);
    const complex_t IT_0040 = IT_0037 + IT_0038 + IT_0039;
    const complex_t IT_0041 = -IT_0040;
    const complex_t IT_0042 = IT_0036 + IT_0041;
    const complex_t IT_0043 = gw*gwuR*U_utR_22;
    ...
    const complex_t IT_0050 = std::conj(lpp_201)*std::conj(U_dtR_10);
    const complex_t IT_0051 = std::conj(lpp_202)*std::conj(U_dtR_20);
    const complex_t IT_0052 = IT_0050 + IT_0051;
    const complex_t IT_0053 = std::conj(lpp_210)*std::conj(U_dtR_10);
    const complex_t IT_0054 = std::conj(lpp_220)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0063 = std::conj(lpp_201)*std::conj(U_dtR_11);
    const complex_t IT_0064 = std::conj(lpp_202)*std::conj(U_dtR_21);
    const complex_t IT_0065 = IT_0063 + IT_0064;
    const complex_t IT_0066 = std::conj(lpp_210)*std::conj(U_dtR_11);
    const complex_t IT_0067 = std::conj(lpp_220)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0075 = std::conj(lpp_201)*std::conj(U_dtR_12);
    const complex_t IT_0076 = std::conj(lpp_202)*std::conj(U_dtR_22);
    const complex_t IT_0077 = IT_0075 + IT_0076;
    const complex_t IT_0078 = std::conj(lpp_210)*std::conj(U_dtR_12);
    const complex_t IT_0079 = std::conj(lpp_220)*std::conj(U_dtR_22);
    ...
    const complex_t IT_0091 = std::conj(lpp_201)*std::conj(U_dtR_00);
    const complex_t IT_0092 = std::conj(lpp_221)*std::conj(U_dtR_20);
    const complex_t IT_0093 = IT_0091 + IT_0092;
    const complex_t IT_0094 = std::conj(lpp_210)*std::conj(U_dtR_00);
    const complex_t IT_0095 = std::conj(lpp_212)*std::conj(U_dtR_20);
    const complex_t IT_0096 = -IT_0094 + -IT_0095;
    const complex_t IT_0097 = IT_0093 + IT_0096;
    const complex_t IT_0098 = gw*gwdR*U_dtR_00;
    const complex_t IT_0099 = IT_0097*IT_0098;
    const complex_t IT_0100 = std::pow(m_d, 2);
    const complex_t IT_0101 = std::pow((-2)*s_24 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0014 + -IT_0060 + IT_0100, -1);
    const complex_t IT_0102 = (complex_t{0, 1})*IT_0099*IT_0101;
    const complex_t IT_0103 = std::conj(lpp_201)*std::conj(U_dtR_01);
    const complex_t IT_0104 = std::conj(lpp_221)*std::conj(U_dtR_21);
    const complex_t IT_0105 = IT_0103 + IT_0104;
    const complex_t IT_0106 = std::conj(lpp_210)*std::conj(U_dtR_01);
    const complex_t IT_0107 = std::conj(lpp_212)*std::conj(U_dtR_21);
    const complex_t IT_0108 = -IT_0106 + -IT_0107;
    const complex_t IT_0109 = IT_0105 + IT_0108;
    const complex_t IT_0110 = gw*gwdR*U_dtR_01;
    const complex_t IT_0111 = IT_0109*IT_0110;
    const complex_t IT_0112 = std::pow((-2)*s_24 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0014 + -IT_0072 + IT_0100, -1);
    const complex_t IT_0113 = (complex_t{0, 1})*IT_0111*IT_0112;
    const complex_t IT_0114 = std::conj(lpp_201)*std::conj(U_dtR_02);
    const complex_t IT_0115 = std::conj(lpp_221)*std::conj(U_dtR_22);
    const complex_t IT_0116 = IT_0114 + IT_0115;
    const complex_t IT_0117 = std::conj(lpp_210)*std::conj(U_dtR_02);
    const complex_t IT_0118 = std::conj(lpp_212)*std::conj(U_dtR_22);
    const complex_t IT_0119 = -IT_0117 + -IT_0118;
    const complex_t IT_0120 = IT_0116 + IT_0119;
    const complex_t IT_0121 = gw*gwdR*U_dtR_02;
    const complex_t IT_0122 = IT_0120*IT_0121;
    const complex_t IT_0123 = std::pow((-2)*s_24 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0014 + -IT_0084 + IT_0100, -1);
    const complex_t IT_0124 = (complex_t{0, 1})*IT_0122*IT_0123;
    const complex_t IT_0125 = IT_0102 + IT_0113 + IT_0124;
    const complex_t IT_0126 = -IT_0088;
    const complex_t IT_0127 = IT_0049 + IT_0126;
    const complex_t IT_0128 = IT_0089 + IT_0127;
    const complex_t IT_0129 = (-6)*IT_0128;
    const complex_t IT_0130 = IT_0090 + IT_0127;
    const complex_t IT_0131 = (-6)*IT_0130;
    const complex_t IT_0132 = IT_0048*(12*std::conj(IT_0048)*IT_0049 + 6
      *std::conj(IT_0087)*(IT_0049 + IT_0088 + IT_0090) + std::conj(IT_0125)
      *IT_0129) + IT_0125*(12*IT_0089*std::conj(IT_0125) + std::conj(IT_0048)
      *IT_0129 + std::conj(IT_0087)*IT_0131) + IT_0087*(12*std::conj(IT_0087)
      *IT_0088 + 6*std::conj(IT_0048)*(IT_0049 + IT_0088 + IT_0090) + std::conj
      (IT_0125)*IT_0131);
    return IT_0132;
}
