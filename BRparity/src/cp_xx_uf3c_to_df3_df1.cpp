...
complex_t CP_XX_uf3c_to_df3_df1(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0003 = std::conj(lpp_220)*std::conj(U_dtR_00);
    const complex_t IT_0004 = std::conj(lpp_221)*std::conj(U_dtR_10);
    ...
    const complex_t IT_0015 = std::conj(lpp_202)*std::conj(U_dtR_01);
    const complex_t IT_0016 = std::conj(lpp_212)*std::conj(U_dtR_11);
    const complex_t IT_0017 = IT_0015 + IT_0016;
    const complex_t IT_0018 = std::conj(lpp_220)*std::conj(U_dtR_01);
    const complex_t IT_0019 = std::conj(lpp_221)*std::conj(U_dtR_11);
    ...
    const complex_t IT_0027 = std::conj(lpp_202)*std::conj(U_dtR_02);
    const complex_t IT_0028 = std::conj(lpp_212)*std::conj(U_dtR_12);
    const complex_t IT_0029 = IT_0027 + IT_0028;
    const complex_t IT_0030 = std::conj(lpp_220)*std::conj(U_dtR_02);
    const complex_t IT_0031 = std::conj(lpp_221)*std::conj(U_dtR_12);
    ...
    const complex_t IT_0041 = std::conj(lpp_002)*std::conj(U_utR_00);
    const complex_t IT_0042 = std::conj(lpp_102)*std::conj(U_utR_10);
    const complex_t IT_0043 = std::conj(lpp_202)*std::conj(U_utR_20);
    const complex_t IT_0044 = IT_0041 + IT_0042 + IT_0043;
    const complex_t IT_0045 = std::conj(lpp_020)*std::conj(U_utR_00);
    const complex_t IT_0046 = std::conj(lpp_120)*std::conj(U_utR_10);
    const complex_t IT_0047 = std::conj(lpp_220)*std::conj(U_utR_20);
    ...
    const complex_t IT_0055 = std::pow(2*s_23 + (complex_t{0, 1})*GuRt*m_utR1 
      + IT_0011 + IT_0053 + -IT_0054, -1);
    const complex_t IT_0056 = (complex_t{0, 1})*IT_0052*IT_0055;
    const complex_t IT_0057 = std::conj(lpp_002)*std::conj(U_utR_01);
    const complex_t IT_0058 = std::conj(lpp_102)*std::conj(U_utR_11);
    const complex_t IT_0059 = std::conj(lpp_202)*std::conj(U_utR_21);
    const complex_t IT_0060 = IT_0057 + IT_0058 + IT_0059;
    const complex_t IT_0061 = std::conj(lpp_020)*std::conj(U_utR_01);
    const complex_t IT_0062 = std::conj(lpp_120)*std::conj(U_utR_11);
    const complex_t IT_0063 = std::conj(lpp_220)*std::conj(U_utR_21);
    ...
    const complex_t IT_0070 = std::pow(2*s_23 + (complex_t{0, 1})*GcRt*m_utR2 
      + IT_0011 + IT_0053 + -IT_0069, -1);
    const complex_t IT_0071 = (complex_t{0, 1})*IT_0068*IT_0070;
    const complex_t IT_0072 = std::conj(lpp_002)*std::conj(U_utR_02);
    const complex_t IT_0073 = std::conj(lpp_102)*std::conj(U_utR_12);
    const complex_t IT_0074 = std::conj(lpp_202)*std::conj(U_utR_22);
    const complex_t IT_0075 = IT_0072 + IT_0073 + IT_0074;
    const complex_t IT_0076 = std::conj(lpp_020)*std::conj(U_utR_02);
    const complex_t IT_0077 = std::conj(lpp_120)*std::conj(U_utR_12);
    const complex_t IT_0078 = std::conj(lpp_220)*std::conj(U_utR_22);
    ...
    const complex_t IT_0085 = std::pow(2*s_23 + (complex_t{0, 1})*GtRt*m_utR3 
      + IT_0011 + IT_0053 + -IT_0084, -1);
    ...
    const complex_t IT_0091 = IT_0040 + IT_0088 + IT_0090;
    const complex_t IT_0092 = -IT_0091;
    const complex_t IT_0093 = std::conj(lpp_201)*std::conj(U_dtR_10);
    const complex_t IT_0094 = std::conj(lpp_202)*std::conj(U_dtR_20);
    const complex_t IT_0095 = IT_0093 + IT_0094;
    const complex_t IT_0096 = std::conj(lpp_210)*std::conj(U_dtR_10);
    const complex_t IT_0097 = std::conj(lpp_220)*std::conj(U_dtR_20);
    const complex_t IT_0098 = -IT_0096 + -IT_0097;
    const complex_t IT_0099 = IT_0095 + IT_0098;
    const complex_t IT_0100 = gw*gwdR*U_dtR_20;
    const complex_t IT_0101 = IT_0099*IT_0100;
    const complex_t IT_0102 = std::pow(m_b, 2);
    const complex_t IT_0103 = std::pow((-2)*s_24 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0011 + -IT_0012 + IT_0102, -1);
    const complex_t IT_0104 = (complex_t{0, 1})*IT_0101*IT_0103;
    const complex_t IT_0105 = std::conj(lpp_201)*std::conj(U_dtR_11);
    const complex_t IT_0106 = std::conj(lpp_202)*std::conj(U_dtR_21);
    const complex_t IT_0107 = IT_0105 + IT_0106;
    const complex_t IT_0108 = std::conj(lpp_210)*std::conj(U_dtR_11);
    const complex_t IT_0109 = std::conj(lpp_220)*std::conj(U_dtR_21);
    const complex_t IT_0110 = -IT_0108 + -IT_0109;
    const complex_t IT_0111 = IT_0107 + IT_0110;
    const complex_t IT_0112 = gw*gwdR*U_dtR_21;
    const complex_t IT_0113 = IT_0111*IT_0112;
    const complex_t IT_0114 = std::pow((-2)*s_24 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0011 + -IT_0024 + IT_0102, -1);
    const complex_t IT_0115 = (complex_t{0, 1})*IT_0113*IT_0114;
    const complex_t IT_0116 = std::conj(lpp_201)*std::conj(U_dtR_12);
    const complex_t IT_0117 = std::conj(lpp_202)*std::conj(U_dtR_22);
    const complex_t IT_0118 = IT_0116 + IT_0117;
    const complex_t IT_0119 = std::conj(lpp_210)*std::conj(U_dtR_12);
    const complex_t IT_0120 = std::conj(lpp_220)*std::conj(U_dtR_22);
    const complex_t IT_0121 = -IT_0119 + -IT_0120;
    const complex_t IT_0122 = IT_0118 + IT_0121;
    const complex_t IT_0123 = gw*gwdR*U_dtR_22;
    const complex_t IT_0124 = IT_0122*IT_0123;
    const complex_t IT_0125 = std::pow((-2)*s_24 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0011 + -IT_0036 + IT_0102, -1);
    const complex_t IT_0126 = (complex_t{0, 1})*IT_0124*IT_0125;
    const complex_t IT_0127 = IT_0104 + IT_0115 + IT_0126;
    const complex_t IT_0128 = -IT_0040;
    const complex_t IT_0129 = IT_0088 + IT_0128;
    const complex_t IT_0130 = IT_0090 + IT_0129;
    ...
    const complex_t IT_0133 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + 0.5
      *std::conj(IT_0087)*IT_0092 + 0.5*std::conj(IT_0127)*IT_0131) + 2*IT_0087*
      (std::conj(IT_0087)*IT_0088 + 0.5*std::conj(IT_0127)*(IT_0089 + IT_0129) +
       IT_0092*IT_0132) + 2*IT_0127*(IT_0089*std::conj(IT_0127) + 0.5*std::conj
      (IT_0087)*(IT_0089 + IT_0129) + IT_0131*IT_0132);
    return IT_0133;
}
