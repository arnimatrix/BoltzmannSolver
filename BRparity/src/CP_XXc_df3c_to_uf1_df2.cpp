        ...
        )
{
    ...
    const complex_t IT_0032 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    const complex_t IT_0064 = m_b*m_s*m_u*m_XX;
    ...
    const complex_t IT_0059 = m_s*m_u*s_12;
    ...
    const complex_t IT_0096 = std::conj(lpp_001)*std::conj(U_dtR_00);
    const complex_t IT_0097 = std::conj(lpp_010)*std::conj(U_dtR_00);
    const complex_t IT_0098 = std::conj(lpp_012)*std::conj(U_dtR_20);
    const complex_t IT_0099 = std::conj(lpp_021)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0106 = std::conj(lpp_010)*std::conj(U_dtR_01);
    const complex_t IT_0107 = std::conj(lpp_012)*std::conj(U_dtR_21);
    const complex_t IT_0108 = std::conj(lpp_021)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0114 = std::conj(lpp_001)*std::conj(U_dtR_02);
    const complex_t IT_0115 = std::conj(lpp_010)*std::conj(U_dtR_02);
    const complex_t IT_0116 = std::conj(lpp_012)*std::conj(U_dtR_22);
