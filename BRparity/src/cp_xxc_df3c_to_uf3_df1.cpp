        ...
        )
{
    ...
    const complex_t IT_0041 = std::conj(lpp_201)*std::conj(U_dtR_10);
    const complex_t IT_0042 = std::conj(lpp_202)*std::conj(U_dtR_20);
    const complex_t IT_0043 = IT_0041 + IT_0042;
    const complex_t IT_0044 = std::conj(lpp_210)*std::conj(U_dtR_10);
    const complex_t IT_0045 = std::conj(lpp_220)*std::conj(U_dtR_20);
    const complex_t IT_0046 = -IT_0044 + -IT_0045;
    const complex_t IT_0047 = IT_0043 + IT_0046;
    const complex_t IT_0048 = gw*gwdR*U_dtR_20;
    ...
    const complex_t IT_0051 = std::pow(2*s_23 + (complex_t{0, 1})*GdRt*m_dtR1 
      + IT_0011 + -IT_0012 + IT_0050, -1);
    const complex_t IT_0052 = (complex_t{0, 1})*IT_0049*IT_0051;
    const complex_t IT_0053 = std::conj(lpp_201)*std::conj(U_dtR_11);
    const complex_t IT_0054 = std::conj(lpp_202)*std::conj(U_dtR_21);
    const complex_t IT_0055 = IT_0053 + IT_0054;
    const complex_t IT_0056 = std::conj(lpp_210)*std::conj(U_dtR_11);
    const complex_t IT_0057 = std::conj(lpp_220)*std::conj(U_dtR_21);
    const complex_t IT_0058 = -IT_0056 + -IT_0057;
    const complex_t IT_0059 = IT_0055 + IT_0058;
    const complex_t IT_0060 = gw*gwdR*U_dtR_21;
    const complex_t IT_0061 = IT_0059*IT_0060;
    const complex_t IT_0062 = std::pow(2*s_23 + (complex_t{0, 1})*GsRt*m_dtR2 
      + IT_0011 + -IT_0024 + IT_0050, -1);
    const complex_t IT_0063 = (complex_t{0, 1})*IT_0061*IT_0062;
    const complex_t IT_0064 = std::conj(lpp_201)*std::conj(U_dtR_12);
    const complex_t IT_0065 = std::conj(lpp_202)*std::conj(U_dtR_22);
    const complex_t IT_0066 = IT_0064 + IT_0065;
    const complex_t IT_0067 = std::conj(lpp_210)*std::conj(U_dtR_12);
    const complex_t IT_0068 = std::conj(lpp_220)*std::conj(U_dtR_22);
    const complex_t IT_0069 = -IT_0067 + -IT_0068;
    const complex_t IT_0070 = IT_0066 + IT_0069;
    const complex_t IT_0071 = gw*gwdR*U_dtR_22;
    const complex_t IT_0072 = IT_0070*IT_0071;
    const complex_t IT_0073 = std::pow(2*s_23 + (complex_t{0, 1})*GbRt*m_dtR3 
      + IT_0011 + -IT_0036 + IT_0050, -1);
    const complex_t IT_0074 = (complex_t{0, 1})*IT_0072*IT_0073;
    const complex_t IT_0075 = -IT_0052 + -IT_0063 + -IT_0074;
    const complex_t IT_0076 = s_24*s_35;
    const complex_t IT_0077 = -IT_0040;
    const complex_t IT_0078 = IT_0076 + IT_0077;
    const complex_t IT_0079 = s_23*s_45;
    const complex_t IT_0080 = -IT_0079;
    const complex_t IT_0081 = IT_0078 + IT_0080;
    const complex_t IT_0082 = std::conj(lpp_002)*std::conj(U_utR_00);
    const complex_t IT_0083 = std::conj(lpp_102)*std::conj(U_utR_10);
    const complex_t IT_0084 = std::conj(lpp_202)*std::conj(U_utR_20);
    const complex_t IT_0085 = IT_0082 + IT_0083 + IT_0084;
    const complex_t IT_0086 = std::conj(lpp_020)*std::conj(U_utR_00);
    const complex_t IT_0087 = std::conj(lpp_120)*std::conj(U_utR_10);
    const complex_t IT_0088 = std::conj(lpp_220)*std::conj(U_utR_20);
    const complex_t IT_0089 = IT_0086 + IT_0087 + IT_0088;
    const complex_t IT_0090 = -IT_0089;
    const complex_t IT_0091 = IT_0085 + IT_0090;
    const complex_t IT_0092 = gw*gwuR*U_utR_20;
    ...
    const complex_t IT_0098 = std::conj(lpp_002)*std::conj(U_utR_01);
    const complex_t IT_0099 = std::conj(lpp_102)*std::conj(U_utR_11);
    const complex_t IT_0100 = std::conj(lpp_202)*std::conj(U_utR_21);
    const complex_t IT_0101 = IT_0098 + IT_0099 + IT_0100;
    const complex_t IT_0102 = std::conj(lpp_020)*std::conj(U_utR_01);
    const complex_t IT_0103 = std::conj(lpp_120)*std::conj(U_utR_11);
    const complex_t IT_0104 = std::conj(lpp_220)*std::conj(U_utR_21);
    const complex_t IT_0105 = IT_0102 + IT_0103 + IT_0104;
    const complex_t IT_0106 = -IT_0105;
    const complex_t IT_0107 = IT_0101 + IT_0106;
    const complex_t IT_0108 = gw*gwuR*U_utR_21;
    ...
    const complex_t IT_0113 = std::conj(lpp_002)*std::conj(U_utR_02);
    const complex_t IT_0114 = std::conj(lpp_102)*std::conj(U_utR_12);
    const complex_t IT_0115 = std::conj(lpp_202)*std::conj(U_utR_22);
    const complex_t IT_0116 = IT_0113 + IT_0114 + IT_0115;
    const complex_t IT_0117 = std::conj(lpp_020)*std::conj(U_utR_02);
    const complex_t IT_0118 = std::conj(lpp_120)*std::conj(U_utR_12);
    const complex_t IT_0119 = std::conj(lpp_220)*std::conj(U_utR_22);
    const complex_t IT_0120 = IT_0117 + IT_0118 + IT_0119;
    const complex_t IT_0121 = -IT_0120;
    const complex_t IT_0122 = IT_0116 + IT_0121;
    const complex_t IT_0123 = gw*gwuR*U_utR_22;
    ...
    const complex_t IT_0129 = IT_0078 + IT_0079;
    const complex_t IT_0130 = (-0.5)*std::conj(IT_0039);
    const complex_t IT_0131 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + (-0.5)
      *std::conj(IT_0075)*IT_0081 + (-0.5)*(IT_0040 + IT_0076 + IT_0080)
      *std::conj(IT_0128)) + 2*IT_0128*(IT_0076*std::conj(IT_0128) + 0.5
      *std::conj(IT_0075)*IT_0129 + (IT_0040 + IT_0076 + IT_0080)*IT_0130) + 2
      *IT_0075*(std::conj(IT_0075)*IT_0079 + 0.5*std::conj(IT_0128)*IT_0129 +
       IT_0081*IT_0130);
    return IT_0131;
}
