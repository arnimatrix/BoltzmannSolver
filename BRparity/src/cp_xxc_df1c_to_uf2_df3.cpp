...
complex_t CP_XXc_df1c_to_uf2_df3(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0091 = -IT_0040;
    const complex_t IT_0092 = IT_0088 + IT_0091;
    const complex_t IT_0093 = IT_0090 + IT_0092;
    const complex_t IT_0094 = std::conj(lpp_102)*std::conj(U_dtR_00);
    const complex_t IT_0095 = std::conj(lpp_112)*std::conj(U_dtR_10);
    const complex_t IT_0096 = IT_0094 + IT_0095;
    const complex_t IT_0097 = std::conj(lpp_120)*std::conj(U_dtR_00);
    const complex_t IT_0098 = std::conj(lpp_121)*std::conj(U_dtR_10);
    const complex_t IT_0099 = -IT_0097 + -IT_0098;
    const complex_t IT_0100 = IT_0096 + IT_0099;
    const complex_t IT_0101 = gw*gwdR*U_dtR_00;
    const complex_t IT_0102 = IT_0100*IT_0101;
    const complex_t IT_0103 = std::pow(m_d, 2);
    const complex_t IT_0104 = std::pow(2*s_23 + (complex_t{0, 1})*GdRt*m_dtR1 
      + IT_0011 + -IT_0012 + IT_0103, -1);
    const complex_t IT_0105 = (complex_t{0, 1})*IT_0102*IT_0104;
    const complex_t IT_0106 = std::conj(lpp_102)*std::conj(U_dtR_01);
    const complex_t IT_0107 = std::conj(lpp_112)*std::conj(U_dtR_11);
    const complex_t IT_0108 = IT_0106 + IT_0107;
    const complex_t IT_0109 = std::conj(lpp_120)*std::conj(U_dtR_01);
    const complex_t IT_0110 = std::conj(lpp_121)*std::conj(U_dtR_11);
    const complex_t IT_0111 = -IT_0109 + -IT_0110;
    const complex_t IT_0112 = IT_0108 + IT_0111;
    const complex_t IT_0113 = gw*gwdR*U_dtR_01;
    const complex_t IT_0114 = IT_0112*IT_0113;
    const complex_t IT_0115 = std::pow(2*s_23 + (complex_t{0, 1})*GsRt*m_dtR2 
      + IT_0011 + -IT_0024 + IT_0103, -1);
    const complex_t IT_0116 = (complex_t{0, 1})*IT_0114*IT_0115;
    const complex_t IT_0117 = std::conj(lpp_102)*std::conj(U_dtR_02);
    const complex_t IT_0118 = std::conj(lpp_112)*std::conj(U_dtR_12);
    const complex_t IT_0119 = IT_0117 + IT_0118;
    const complex_t IT_0120 = std::conj(lpp_120)*std::conj(U_dtR_02);
    const complex_t IT_0121 = std::conj(lpp_121)*std::conj(U_dtR_12);
    const complex_t IT_0122 = -IT_0120 + -IT_0121;
    const complex_t IT_0123 = IT_0119 + IT_0122;
    const complex_t IT_0124 = gw*gwdR*U_dtR_02;
    const complex_t IT_0125 = IT_0123*IT_0124;
    const complex_t IT_0126 = std::pow(2*s_23 + (complex_t{0, 1})*GbRt*m_dtR3 
      + IT_0011 + -IT_0036 + IT_0103, -1);
    const complex_t IT_0127 = (complex_t{0, 1})*IT_0125*IT_0126;
    const complex_t IT_0128 = -IT_0105 + -IT_0116 + -IT_0127;
    const complex_t IT_0129 = 0.5*std::conj(IT_0128);
    const complex_t IT_0130 = IT_0089 + IT_0092;
    const complex_t IT_0131 = 0.5*std::conj(IT_0039);
    const complex_t IT_0132 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + 0.5
      *std::conj(IT_0087)*(IT_0040 + IT_0088 + IT_0090) + IT_0093*IT_0129) + 2
      *IT_0087*(std::conj(IT_0087)*IT_0088 + IT_0129*IT_0130 + (IT_0040 +
       IT_0088 + IT_0090)*IT_0131) + 2*IT_0128*(IT_0089*std::conj(IT_0128) + 0.5
      *std::conj(IT_0087)*IT_0130 + IT_0093*IT_0131);
    return IT_0132;
}
