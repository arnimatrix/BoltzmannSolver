...
complex_t CP_XX_XXc_to_uf1_uf1c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t U_utL_00 = param.U_utL_00;
    const complex_t U_utL_01 = param.U_utL_01;
    const complex_t U_utL_02 = param.U_utL_02;
    const complex_t U_utR_00 = param.U_utR_00;
    const complex_t U_utR_01 = param.U_utR_01;
    const complex_t U_utR_02 = param.U_utR_02;
    const complex_t IT_0031 = (complex_t{0, -1})*gw*gwuL*U_utL_00;
    const complex_t IT_0032 = (complex_t{0, -1})*gw*gwuL*std::conj(U_utL_00);
    ...
    const complex_t IT_0052 = std::pow((-2)*s_23 + (complex_t{0, 1})*GuLt
      *m_utL1 + IT_0003 + IT_0004 + -IT_0034 + reg_prop, -1);
    const complex_t IT_0053 = (complex_t{0, 1})*IT_0033*IT_0052;
    const complex_t IT_0037 = (complex_t{0, -1})*gw*gwuL*U_utL_01;
    const complex_t IT_0038 = (complex_t{0, -1})*gw*gwuL*std::conj(U_utL_01);
    const complex_t IT_0039 = IT_0037*IT_0038;
    const complex_t IT_0040 = std::pow(m_utL2, 2);
    const complex_t IT_0054 = std::pow((-2)*s_23 + (complex_t{0, 1})*GcLt
      *m_utL2 + IT_0003 + IT_0004 + -IT_0040 + reg_prop, -1);
    const complex_t IT_0055 = (complex_t{0, 1})*IT_0039*IT_0054;
    const complex_t IT_0043 = (complex_t{0, -1})*gw*gwuL*U_utL_02;
    const complex_t IT_0044 = (complex_t{0, -1})*gw*gwuL*std::conj(U_utL_02);
    const complex_t IT_0045 = IT_0043*IT_0044;
    const complex_t IT_0046 = std::pow(m_utL3, 2);
    const complex_t IT_0056 = std::pow((-2)*s_23 + (complex_t{0, 1})*GtLt
    ...
    const complex_t IT_0035 = std::pow((-2)*s_13 + (complex_t{0, 1})*GuLt
      *m_utL1 + IT_0003 + IT_0004 + -IT_0034 + reg_prop, -1);
    const complex_t IT_0036 = (complex_t{0, 1})*IT_0033*IT_0035;
    const complex_t IT_0041 = std::pow((-2)*s_13 + (complex_t{0, 1})*GcLt
      *m_utL2 + IT_0003 + IT_0004 + -IT_0040 + reg_prop, -1);
    const complex_t IT_0042 = (complex_t{0, 1})*IT_0039*IT_0041;
    const complex_t IT_0047 = std::pow((-2)*s_13 + (complex_t{0, 1})*GtLt
      *m_utL3 + IT_0003 + IT_0004 + -IT_0046 + reg_prop, -1);
    const complex_t IT_0048 = (complex_t{0, 1})*IT_0045*IT_0047;
    const complex_t IT_0049 = (-0.5)*IT_0036 + (-0.5)*IT_0042 + (-0.5)*IT_0048;
    const complex_t IT_0000 = (complex_t{0, -1})*gw*gwuR*U_utR_00;
    const complex_t IT_0001 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_00);
    const complex_t IT_0002 = IT_0000*IT_0001;
    const complex_t IT_0005 = std::pow(m_utR1, 2);
    const complex_t IT_0022 = std::pow((-2)*s_13 + (complex_t{0, 1})*GuRt
      *m_utR1 + IT_0003 + IT_0004 + -IT_0005 + reg_prop, -1);
    const complex_t IT_0023 = (complex_t{0, 1})*IT_0002*IT_0022;
    const complex_t IT_0008 = (complex_t{0, -1})*gw*gwuR*U_utR_01;
    const complex_t IT_0009 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_01);
    ...
    const complex_t IT_0014 = (complex_t{0, -1})*gw*gwuR*U_utR_02;
    const complex_t IT_0015 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_02);
    const complex_t IT_0016 = IT_0014*IT_0015;
    const complex_t IT_0017 = std::pow(m_utR3, 2);
    const complex_t IT_0026 = std::pow((-2)*s_13 + (complex_t{0, 1})*GtRt
    ...
    const complex_t IT_0006 = std::pow((-2)*s_23 + (complex_t{0, 1})*GuRt
      *m_utR1 + IT_0003 + IT_0004 + -IT_0005 + reg_prop, -1);
    const complex_t IT_0007 = (complex_t{0, 1})*IT_0002*IT_0006;
    const complex_t IT_0012 = std::pow((-2)*s_23 + (complex_t{0, 1})*GcRt
      *m_utR2 + IT_0003 + IT_0004 + -IT_0011 + reg_prop, -1);
    const complex_t IT_0013 = (complex_t{0, 1})*IT_0010*IT_0012;
    const complex_t IT_0018 = std::pow((-2)*s_23 + (complex_t{0, 1})*GtRt
      *m_utR3 + IT_0003 + IT_0004 + -IT_0017 + reg_prop, -1);
