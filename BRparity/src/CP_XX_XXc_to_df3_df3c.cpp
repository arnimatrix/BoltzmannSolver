...
complex_t CP_XX_XXc_to_df3_df3c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t U_dtL_20 = param.U_dtL_20;
    const complex_t U_dtL_21 = param.U_dtL_21;
    const complex_t U_dtL_22 = param.U_dtL_22;
    const complex_t U_dtR_20 = param.U_dtR_20;
    const complex_t U_dtR_21 = param.U_dtR_21;
    const complex_t U_dtR_22 = param.U_dtR_22;
    const complex_t IT_0031 = (complex_t{0, -1})*gw*gwdL*U_dtL_20;
    const complex_t IT_0032 = (complex_t{0, -1})*gw*gwdL*std::conj(U_dtL_20);
    const complex_t IT_0033 = IT_0031*IT_0032;
    const complex_t IT_0003 = std::pow(m_b, 2);
    ...
    const complex_t IT_0037 = (complex_t{0, -1})*gw*gwdL*U_dtL_21;
    const complex_t IT_0038 = (complex_t{0, -1})*gw*gwdL*std::conj(U_dtL_21);
    ...
    const complex_t IT_0043 = (complex_t{0, -1})*gw*gwdL*U_dtL_22;
    const complex_t IT_0044 = (complex_t{0, -1})*gw*gwdL*std::conj(U_dtL_22);
    ...
    const complex_t IT_0001 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_20);
    ...
    const complex_t IT_0008 = (complex_t{0, -1})*gw*gwdR*U_dtR_21;
    const complex_t IT_0009 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_21);
    ...
    const complex_t IT_0014 = (complex_t{0, -1})*gw*gwdR*U_dtR_22;
    const complex_t IT_0015 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_22);
