        ...
        )
{
    ...
    const complex_t IT_0047 = m_b*m_c*m_s*m_XX;
    const complex_t IT_0048 = 192*IT_0047;
    const complex_t IT_0049 = IT_0046 + IT_0048;
    const complex_t IT_0050 = lpp_101*U_dtR_00;
    const complex_t IT_0051 = lpp_110*U_dtR_00;
    const complex_t IT_0052 = lpp_112*U_dtR_20;
    const complex_t IT_0053 = lpp_121*U_dtR_20;
    ...
    const complex_t IT_0060 = lpp_101*U_dtR_01;
    const complex_t IT_0061 = lpp_110*U_dtR_01;
    const complex_t IT_0062 = lpp_112*U_dtR_21;
    const complex_t IT_0063 = lpp_121*U_dtR_21;
    ...
    const complex_t IT_0069 = lpp_101*U_dtR_02;
    const complex_t IT_0070 = lpp_110*U_dtR_02;
    const complex_t IT_0071 = lpp_112*U_dtR_22;
    const complex_t IT_0072 = lpp_121*U_dtR_22;
