        ...
        )
{
    ...
    const complex_t IT_0109 = lpp_001*U_dtR_00;
    const complex_t IT_0110 = lpp_021*U_dtR_20;
    const complex_t IT_0111 = IT_0109 + IT_0110;
    const complex_t IT_0112 = lpp_010*U_dtR_00;
    const complex_t IT_0113 = lpp_012*U_dtR_20;
    ...
    const complex_t IT_0121 = lpp_021*U_dtR_22;
    const complex_t IT_0122 = IT_0120 + IT_0121;
    const complex_t IT_0123 = lpp_010*U_dtR_02;
    const complex_t IT_0124 = lpp_012*U_dtR_22;
