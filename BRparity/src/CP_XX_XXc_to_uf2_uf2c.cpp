        ...
        )
{
    ...
    const complex_t U_utL_10 = param.U_utL_10;
    const complex_t U_utL_11 = param.U_utL_11;
    const complex_t U_utL_12 = param.U_utL_12;
    const complex_t U_utR_10 = param.U_utR_10;
    const complex_t U_utR_11 = param.U_utR_11;
    const complex_t U_utR_12 = param.U_utR_12;
    const complex_t IT_0031 = (complex_t{0, -1})*gw*gwuL*U_utL_10;
    const complex_t IT_0032 = (complex_t{0, -1})*gw*gwuL*std::conj(U_utL_10);
    ...
    const complex_t IT_0037 = (complex_t{0, -1})*gw*gwuL*U_utL_11;
    const complex_t IT_0038 = (complex_t{0, -1})*gw*gwuL*std::conj(U_utL_11);
    ...
    const complex_t IT_0043 = (complex_t{0, -1})*gw*gwuL*U_utL_12;
    const complex_t IT_0044 = (complex_t{0, -1})*gw*gwuL*std::conj(U_utL_12);
    ...
    const complex_t IT_0001 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_10);
    ...
    const complex_t IT_0008 = (complex_t{0, -1})*gw*gwuR*U_utR_11;
    const complex_t IT_0009 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_11);
    ...
    const complex_t IT_0014 = (complex_t{0, -1})*gw*gwuR*U_utR_12;
    const complex_t IT_0015 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_12);
