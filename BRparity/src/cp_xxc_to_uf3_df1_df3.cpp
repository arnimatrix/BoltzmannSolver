...
complex_t CP_XXc_to_uf3_df1_df3(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0096 = std::pow((-2)*s_23 + (complex_t{0, 1})*GuRt
    ...
    const complex_t IT_0111 = std::pow((-2)*s_23 + (complex_t{0, 1})*GcRt
    ...
    const complex_t IT_0126 = std::pow((-2)*s_23 + (complex_t{0, 1})*GtRt
    ...
    const complex_t IT_0131 = 6*IT_0040 + (-6)*IT_0076 + (-6)*IT_0077;
    const complex_t IT_0132 = IT_0039*(12*std::conj(IT_0039)*IT_0040 + 6
      *std::conj(IT_0075)*IT_0081 + std::conj(IT_0128)*IT_0130) + IT_0128*(12
      *IT_0076*std::conj(IT_0128) + std::conj(IT_0039)*IT_0130 + std::conj
      (IT_0075)*IT_0131) + IT_0075*(12*std::conj(IT_0075)*IT_0077 + 6*std::conj
      (IT_0039)*IT_0081 + std::conj(IT_0128)*IT_0131);
    return IT_0132;
}
