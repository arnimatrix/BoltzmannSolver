...
complex_t CP_XX_to_uf1_df1_df1(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0033 = std::pow(m_u, 2);
    const complex_t IT_0034 = std::pow(2*s_23 + (complex_t{0, 1})*GdRt*m_dtR1 
      + IT_0007 + -IT_0009 + IT_0033 + reg_prop, -1);
    const complex_t IT_0035 = (complex_t{0, 1})*IT_0006*IT_0034;
    const complex_t IT_0036 = std::pow(2*s_23 + (complex_t{0, 1})*GsRt*m_dtR2 
      + IT_0007 + -IT_0019 + IT_0033 + reg_prop, -1);
    const complex_t IT_0037 = (complex_t{0, 1})*IT_0018*IT_0036;
    const complex_t IT_0038 = std::pow(2*s_23 + (complex_t{0, 1})*GbRt*m_dtR3 
    ...
    const complex_t IT_0040 = (-0.25)*IT_0035 + (-0.25)*IT_0037 + (-0.25)
      *IT_0039;
    const complex_t IT_0041 = (-0.5)*IT_0011 + (-0.5)*IT_0021 + (-0.5)*IT_0031;
    const complex_t IT_0042 = s_13*s_24;
    const complex_t IT_0043 = 24*IT_0042;
    const complex_t IT_0044 = s_14*s_23;
    const complex_t IT_0045 = (-24)*IT_0044;
    const complex_t IT_0046 = IT_0043 + IT_0045;
    const complex_t IT_0047 = std::conj(IT_0041)*IT_0046;
    const complex_t IT_0048 = (-24)*IT_0042;
    const complex_t IT_0049 = 24*IT_0044;
    const complex_t IT_0050 = IT_0048 + IT_0049;
    const complex_t IT_0051 = std::conj(IT_0041)*IT_0050;
    const complex_t IT_0052 = IT_0047 + IT_0051;
    const complex_t IT_0053 = (-0.5)*IT_0035 + (-0.5)*IT_0037 + (-0.5)*IT_0039;
    const complex_t IT_0054 = s_12*s_34;
    const complex_t IT_0055 = IT_0046 + IT_0050;
    const complex_t IT_0056 = (-6)*IT_0054;
    const complex_t IT_0057 = 384*IT_0042;
    const complex_t IT_0058 = 384*IT_0044;
    const complex_t IT_0059 = (-192)*IT_0054;
    const complex_t IT_0060 = IT_0057 + IT_0058 + IT_0059;
    const complex_t IT_0061 = m_u*m_XX*IT_0007;
    const complex_t IT_0062 = (-576)*IT_0061;
    const complex_t IT_0063 = IT_0060 + IT_0062;
    const complex_t IT_0064 = 576*IT_0061;
    const complex_t IT_0065 = IT_0060 + IT_0064;
    const complex_t IT_0071 = 192*IT_0054;
    const complex_t IT_0066 = m_u*m_XX*s_34;
    const complex_t IT_0067 = (-288)*IT_0066;
    const complex_t IT_0068 = s_12*IT_0007;
    const complex_t IT_0069 = 288*IT_0068;
    const complex_t IT_0070 = (-192)*IT_0044;
    const complex_t IT_0072 = IT_0062 + IT_0067 + IT_0069 + IT_0070 + IT_0071;
    const complex_t IT_0073 = (-384)*IT_0042;
    const complex_t IT_0074 = IT_0041*IT_0050;
    const complex_t IT_0075 = IT_0046*IT_0053;
    const complex_t IT_0076 = (IT_0032 + IT_0040)*IT_0052 + 6*std::conj
      (IT_0053)*(IT_0053*IT_0054 + 0.166666666666667*(IT_0032 + IT_0040)*IT_0055
       + 0.166666666666667*IT_0041*IT_0056) + 6*std::conj(IT_0041)*(IT_0041
      *IT_0054 + 0.166666666666667*IT_0053*IT_0056) + std::conj(IT_0040)*
      (IT_0041*IT_0046 + IT_0050*IT_0053 + IT_0040*(IT_0063 + IT_0065) + IT_0032
      *((-384)*IT_0044 + IT_0064 + IT_0071 + IT_0072 + IT_0073) + IT_0074 +
       IT_0075) + std::conj(IT_0032)*(IT_0041*IT_0046 + IT_0050*IT_0053 +
       IT_0032*(IT_0063 + IT_0065) + IT_0040*((-384)*IT_0044 + IT_0064 + IT_0071
       + IT_0072 + IT_0073) + IT_0074 + IT_0075);
    return IT_0076;
}
