...
complex_t CP_XX_uf2c_to_df1_df3(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0042 = std::pow(m_c, 2);
    ...
    const complex_t IT_0078 = std::pow((-2)*s_23 + (complex_t{0, 1})*GdRt
    ...
    const complex_t IT_0087 = std::pow((-2)*s_23 + (complex_t{0, 1})*GsRt
    ...
    const complex_t IT_0096 = std::pow((-2)*s_23 + (complex_t{0, 1})*GbRt
    ...
    const complex_t IT_0110 = m_b*m_c*m_d*m_XX;
