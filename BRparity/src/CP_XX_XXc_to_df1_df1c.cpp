...
complex_t CP_XX_XXc_to_df1_df1c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t U_dtL_00 = param.U_dtL_00;
    const complex_t U_dtL_01 = param.U_dtL_01;
    const complex_t U_dtL_02 = param.U_dtL_02;
    const complex_t U_dtR_00 = param.U_dtR_00;
    const complex_t U_dtR_01 = param.U_dtR_01;
    const complex_t U_dtR_02 = param.U_dtR_02;
    const complex_t IT_0031 = (complex_t{0, -1})*gw*gwdL*U_dtL_00;
    const complex_t IT_0032 = (complex_t{0, -1})*gw*gwdL*std::conj(U_dtL_00);
    const complex_t IT_0033 = IT_0031*IT_0032;
    const complex_t IT_0003 = std::pow(m_d, 2);
    const complex_t IT_0004 = std::pow(m_XX, 2);
    const complex_t IT_0034 = std::pow(m_dtL1, 2);
    const complex_t IT_0052 = std::pow((-2)*s_23 + (complex_t{0, 1})*GdLt
      *m_dtL1 + IT_0003 + IT_0004 + -IT_0034 + reg_prop, -1);
    const complex_t IT_0053 = (complex_t{0, 1})*IT_0033*IT_0052;
    const complex_t IT_0037 = (complex_t{0, -1})*gw*gwdL*U_dtL_01;
    const complex_t IT_0038 = (complex_t{0, -1})*gw*gwdL*std::conj(U_dtL_01);
    const complex_t IT_0039 = IT_0037*IT_0038;
    const complex_t IT_0040 = std::pow(m_dtL2, 2);
    const complex_t IT_0054 = std::pow((-2)*s_23 + (complex_t{0, 1})*GsLt
      *m_dtL2 + IT_0003 + IT_0004 + -IT_0040 + reg_prop, -1);
    const complex_t IT_0055 = (complex_t{0, 1})*IT_0039*IT_0054;
    const complex_t IT_0043 = (complex_t{0, -1})*gw*gwdL*U_dtL_02;
    const complex_t IT_0044 = (complex_t{0, -1})*gw*gwdL*std::conj(U_dtL_02);
    const complex_t IT_0045 = IT_0043*IT_0044;
    const complex_t IT_0046 = std::pow(m_dtL3, 2);
    const complex_t IT_0056 = std::pow((-2)*s_23 + (complex_t{0, 1})*GbLt
    ...
    const complex_t IT_0035 = std::pow((-2)*s_13 + (complex_t{0, 1})*GdLt
      *m_dtL1 + IT_0003 + IT_0004 + -IT_0034 + reg_prop, -1);
    const complex_t IT_0036 = (complex_t{0, 1})*IT_0033*IT_0035;
    const complex_t IT_0041 = std::pow((-2)*s_13 + (complex_t{0, 1})*GsLt
      *m_dtL2 + IT_0003 + IT_0004 + -IT_0040 + reg_prop, -1);
    const complex_t IT_0042 = (complex_t{0, 1})*IT_0039*IT_0041;
    const complex_t IT_0047 = std::pow((-2)*s_13 + (complex_t{0, 1})*GbLt
      *m_dtL3 + IT_0003 + IT_0004 + -IT_0046 + reg_prop, -1);
    const complex_t IT_0048 = (complex_t{0, 1})*IT_0045*IT_0047;
    const complex_t IT_0049 = (-0.5)*IT_0036 + (-0.5)*IT_0042 + (-0.5)*IT_0048;
    const complex_t IT_0000 = (complex_t{0, -1})*gw*gwdR*U_dtR_00;
    const complex_t IT_0001 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_00);
    const complex_t IT_0002 = IT_0000*IT_0001;
    const complex_t IT_0005 = std::pow(m_dtR1, 2);
    const complex_t IT_0022 = std::pow((-2)*s_13 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0003 + IT_0004 + -IT_0005 + reg_prop, -1);
    const complex_t IT_0023 = (complex_t{0, 1})*IT_0002*IT_0022;
    const complex_t IT_0008 = (complex_t{0, -1})*gw*gwdR*U_dtR_01;
    const complex_t IT_0009 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_01);
    const complex_t IT_0010 = IT_0008*IT_0009;
    const complex_t IT_0011 = std::pow(m_dtR2, 2);
    const complex_t IT_0024 = std::pow((-2)*s_13 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0003 + IT_0004 + -IT_0011 + reg_prop, -1);
    const complex_t IT_0025 = (complex_t{0, 1})*IT_0010*IT_0024;
    const complex_t IT_0014 = (complex_t{0, -1})*gw*gwdR*U_dtR_02;
    const complex_t IT_0015 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_02);
    const complex_t IT_0016 = IT_0014*IT_0015;
    const complex_t IT_0017 = std::pow(m_dtR3, 2);
    const complex_t IT_0026 = std::pow((-2)*s_13 + (complex_t{0, 1})*GbRt
    ...
    const complex_t IT_0021 = s_14*s_23;
    const complex_t IT_0006 = std::pow((-2)*s_23 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0003 + IT_0004 + -IT_0005 + reg_prop, -1);
    const complex_t IT_0007 = (complex_t{0, 1})*IT_0002*IT_0006;
    const complex_t IT_0012 = std::pow((-2)*s_23 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0003 + IT_0004 + -IT_0011 + reg_prop, -1);
    const complex_t IT_0013 = (complex_t{0, 1})*IT_0010*IT_0012;
    const complex_t IT_0018 = std::pow((-2)*s_23 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0003 + IT_0004 + -IT_0017 + reg_prop, -1);
    ...
    const complex_t IT_0061 = s_13*s_24;
