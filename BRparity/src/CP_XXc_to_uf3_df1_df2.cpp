...
complex_t CP_XXc_to_uf3_df1_df2(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0013 = std::conj(lpp_201)*std::conj(U_dtR_01);
    const complex_t IT_0014 = std::conj(lpp_210)*std::conj(U_dtR_01);
    const complex_t IT_0015 = std::conj(lpp_212)*std::conj(U_dtR_21);
    const complex_t IT_0016 = std::conj(lpp_221)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0023 = std::conj(lpp_201)*std::conj(U_dtR_02);
    const complex_t IT_0024 = std::conj(lpp_210)*std::conj(U_dtR_02);
    const complex_t IT_0025 = std::conj(lpp_212)*std::conj(U_dtR_22);
    const complex_t IT_0026 = std::conj(lpp_221)*std::conj(U_dtR_22);
    ...
    const complex_t IT_0040 = std::conj(lpp_001)*std::conj(U_utR_00);
    const complex_t IT_0041 = std::conj(lpp_101)*std::conj(U_utR_10);
    const complex_t IT_0042 = std::conj(lpp_201)*std::conj(U_utR_20);
    const complex_t IT_0043 = std::conj(lpp_010)*std::conj(U_utR_00);
    const complex_t IT_0044 = std::conj(lpp_110)*std::conj(U_utR_10);
    const complex_t IT_0045 = std::conj(lpp_210)*std::conj(U_utR_20);
    const complex_t IT_0046 = (complex_t{0, 1})*(IT_0040 + IT_0041 + IT_0042 +
       -IT_0043 + -IT_0044 + -IT_0045);
    const complex_t IT_0047 = (complex_t{0, -1})*gw*gwuR*U_utR_20;
    const complex_t IT_0048 = IT_0046*IT_0047;
    const complex_t IT_0049 = std::pow(m_t, 2);
    ...
    const complex_t IT_0053 = std::conj(lpp_001)*std::conj(U_utR_01);
    const complex_t IT_0054 = std::conj(lpp_101)*std::conj(U_utR_11);
    const complex_t IT_0055 = std::conj(lpp_201)*std::conj(U_utR_21);
    const complex_t IT_0056 = std::conj(lpp_010)*std::conj(U_utR_01);
    const complex_t IT_0057 = std::conj(lpp_110)*std::conj(U_utR_11);
    const complex_t IT_0058 = std::conj(lpp_210)*std::conj(U_utR_21);
    const complex_t IT_0059 = (complex_t{0, 1})*(IT_0053 + IT_0054 + IT_0055 +
       -IT_0056 + -IT_0057 + -IT_0058);
    const complex_t IT_0060 = (complex_t{0, -1})*gw*gwuR*U_utR_21;
    ...
    const complex_t IT_0065 = std::conj(lpp_001)*std::conj(U_utR_02);
    const complex_t IT_0066 = std::conj(lpp_101)*std::conj(U_utR_12);
    const complex_t IT_0067 = std::conj(lpp_201)*std::conj(U_utR_22);
    const complex_t IT_0068 = std::conj(lpp_010)*std::conj(U_utR_02);
    const complex_t IT_0069 = std::conj(lpp_110)*std::conj(U_utR_12);
    const complex_t IT_0070 = std::conj(lpp_210)*std::conj(U_utR_22);
    const complex_t IT_0071 = (complex_t{0, 1})*(IT_0065 + IT_0066 + IT_0067 +
       -IT_0068 + -IT_0069 + -IT_0070);
    const complex_t IT_0072 = (complex_t{0, -1})*gw*gwuR*U_utR_22;
    ...
    const complex_t IT_0085 = std::conj(lpp_201)*std::conj(U_dtR_10);
    const complex_t IT_0086 = std::conj(lpp_202)*std::conj(U_dtR_20);
    const complex_t IT_0087 = std::conj(lpp_210)*std::conj(U_dtR_10);
    const complex_t IT_0088 = std::conj(lpp_220)*std::conj(U_dtR_20);
    const complex_t IT_0089 = (complex_t{0, -1})*(IT_0085 + IT_0086 + -IT_0087
       + -IT_0088);
    const complex_t IT_0090 = (complex_t{0, -1})*gw*gwdR*U_dtR_10;
    ...
    const complex_t IT_0094 = std::conj(lpp_201)*std::conj(U_dtR_11);
    const complex_t IT_0095 = std::conj(lpp_202)*std::conj(U_dtR_21);
    const complex_t IT_0096 = std::conj(lpp_210)*std::conj(U_dtR_11);
    const complex_t IT_0097 = std::conj(lpp_220)*std::conj(U_dtR_21);
    const complex_t IT_0098 = (complex_t{0, -1})*(IT_0094 + IT_0095 + -IT_0096
       + -IT_0097);
    const complex_t IT_0099 = (complex_t{0, -1})*gw*gwdR*U_dtR_11;
    ...
    const complex_t IT_0103 = std::conj(lpp_201)*std::conj(U_dtR_12);
    const complex_t IT_0104 = std::conj(lpp_202)*std::conj(U_dtR_22);
    const complex_t IT_0105 = std::conj(lpp_210)*std::conj(U_dtR_12);
    const complex_t IT_0106 = std::conj(lpp_220)*std::conj(U_dtR_22);
    const complex_t IT_0107 = (complex_t{0, -1})*(IT_0103 + IT_0104 + -IT_0105
       + -IT_0106);
    const complex_t IT_0108 = (complex_t{0, -1})*gw*gwdR*U_dtR_12;
    ...
    const complex_t IT_0118 = m_d*m_s*m_t*m_XX;
    ...
    const complex_t IT_0122 = m_d*m_s*s_12;
    const complex_t IT_0123 = 384*IT_0036;
    const complex_t IT_0124 = m_t*m_XX*s_34;
    ...
    const complex_t IT_0131 = (-0.25)*IT_0093 + (-0.25)*IT_0102 + (-0.25)
      *IT_0111;
    const complex_t IT_0132 = (-768)*IT_0034;
    const complex_t IT_0133 = (-768)*IT_0036;
    const complex_t IT_0134 = 384*IT_0083;
    const complex_t IT_0135 = IT_0132 + IT_0133 + IT_0134;
    const complex_t IT_0136 = (-1152)*IT_0118;
    const complex_t IT_0137 = IT_0135 + IT_0136;
    const complex_t IT_0138 = (-576)*IT_0124;
    const complex_t IT_0139 = (-384)*IT_0036;
    const complex_t IT_0140 = 576*IT_0122 + IT_0134 + IT_0136 + IT_0138 +
       IT_0139;
    const complex_t IT_0141 = IT_0119 + IT_0135;
    const complex_t IT_0142 = IT_0080*std::conj(IT_0112);
    const complex_t IT_0143 = std::conj(IT_0033)*IT_0113;
    const complex_t IT_0144 = IT_0038*std::conj(IT_0128);
    const complex_t IT_0145 = IT_0117 + IT_0136;
    ...
    const complex_t IT_0149 = std::conj(IT_0012)*IT_0082 + IT_0033*(std::conj
      ...
      (IT_0121)*(IT_0082 + IT_0130) + std::conj(IT_0131)*(IT_0039 + IT_0081 +
       IT_0038*(IT_0077 + IT_0112) + IT_0129 + IT_0130 + IT_0012*IT_0137 +
       IT_0121*IT_0140 + IT_0128*IT_0141) + IT_0121*(IT_0120*std::conj(IT_0121) 
      + std::conj(IT_0012)*(IT_0116 + IT_0119 + (-576)*IT_0122 + IT_0123 +
       IT_0125) + IT_0126 + IT_0127 + IT_0142) + IT_0077*(IT_0084*(std::conj
      (IT_0077) + std::conj(IT_0112)) + IT_0143 + IT_0144) + IT_0112*(std::conj
      (IT_0012)*IT_0080 + IT_0084*(std::conj(IT_0077) + std::conj(IT_0112)) +
       IT_0143 + IT_0144) + IT_0128*(std::conj(IT_0128)*IT_0145 + IT_0146 +
       IT_0147 + IT_0148) + IT_0131*(IT_0126 + IT_0127 + std::conj(IT_0012)
      *IT_0137 + std::conj(IT_0121)*IT_0140 + std::conj(IT_0128)*IT_0141 +
       IT_0142 + std::conj(IT_0131)*(IT_0120 + IT_0145) + IT_0146 + IT_0147 +
       IT_0148);
    return IT_0149;
}
