        ...
        )
{
    ...
    const complex_t IT_0130 = 2*IT_0087*(std::conj(IT_0087)*IT_0088 + (-0.5)
      *std::conj(IT_0039)*IT_0092 + 0.5*std::conj(IT_0127)*(IT_0088 + IT_0089 +
       IT_0128)) + 2*IT_0127*(IT_0089*std::conj(IT_0127) + 0.5*std::conj(IT_0087
      )*(IT_0088 + IT_0089 + IT_0128) + (-0.5)*std::conj(IT_0039)*IT_0129) + 2
      *IT_0039*(std::conj(IT_0039)*IT_0040 + (-0.5)*std::conj(IT_0087)*IT_0092 +
