...
complex_t CP_XX_df3_to_uf3c_df1c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0003 = lpp_210*U_dtR_10;
    const complex_t IT_0004 = lpp_220*U_dtR_20;
    ...
    const complex_t IT_0013 = lpp_201*U_dtR_11;
    const complex_t IT_0014 = lpp_202*U_dtR_21;
    const complex_t IT_0015 = lpp_210*U_dtR_11;
    const complex_t IT_0016 = lpp_220*U_dtR_21;
    ...
    const complex_t IT_0023 = lpp_201*U_dtR_12;
    const complex_t IT_0024 = lpp_202*U_dtR_22;
    const complex_t IT_0025 = lpp_210*U_dtR_12;
    const complex_t IT_0026 = lpp_220*U_dtR_22;
    ...
    const complex_t IT_0038 = (complex_t{0, 1})*(IT_0034 + IT_0035 + -IT_0036 
      + -IT_0037);
    const complex_t IT_0039 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_00);
    ...
    const complex_t IT_0042 = std::pow((-2)*s_23 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0008 + -IT_0010 + IT_0041 + reg_prop, -1);
    ...
    const complex_t IT_0048 = (complex_t{0, 1})*(IT_0044 + IT_0045 + -IT_0046 
      + -IT_0047);
    const complex_t IT_0049 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_01);
    const complex_t IT_0050 = IT_0048*IT_0049;
    const complex_t IT_0051 = std::pow((-2)*s_23 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0008 + -IT_0020 + IT_0041 + reg_prop, -1);
    ...
    const complex_t IT_0057 = (complex_t{0, 1})*(IT_0053 + IT_0054 + -IT_0055 
      + -IT_0056);
    const complex_t IT_0058 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_02);
    const complex_t IT_0059 = IT_0057*IT_0058;
    const complex_t IT_0060 = std::pow((-2)*s_23 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0008 + -IT_0030 + IT_0041 + reg_prop, -1);
    const complex_t IT_0061 = (complex_t{0, 1})*IT_0059*IT_0060;
    const complex_t IT_0062 = 0.5*IT_0043 + 0.5*IT_0052 + 0.5*IT_0061;
    ...
    const complex_t IT_0067 = lpp_020*U_utR_00;
    const complex_t IT_0068 = lpp_120*U_utR_10;
    const complex_t IT_0069 = lpp_220*U_utR_20;
    const complex_t IT_0070 = (complex_t{0, 1})*(IT_0067 + IT_0068 + IT_0069);
    const complex_t IT_0071 = lpp_002*U_utR_00;
    const complex_t IT_0072 = lpp_102*U_utR_10;
    const complex_t IT_0073 = lpp_202*U_utR_20;
    ...
    const complex_t IT_0077 = lpp_020*U_utR_01;
    const complex_t IT_0078 = lpp_120*U_utR_11;
    const complex_t IT_0079 = lpp_220*U_utR_21;
    ...
    const complex_t IT_0086 = lpp_002*U_utR_01;
    const complex_t IT_0087 = lpp_102*U_utR_11;
    const complex_t IT_0088 = lpp_202*U_utR_21;
    const complex_t IT_0089 = (complex_t{0, 1})*(IT_0086 + IT_0087 + IT_0088);
    const complex_t IT_0090 = IT_0084*IT_0089;
    const complex_t IT_0091 = lpp_020*U_utR_02;
    const complex_t IT_0092 = lpp_120*U_utR_12;
    const complex_t IT_0093 = lpp_220*U_utR_22;
    ...
    const complex_t IT_0100 = lpp_002*U_utR_02;
    const complex_t IT_0101 = lpp_102*U_utR_12;
    const complex_t IT_0102 = lpp_202*U_utR_22;
    ...
    const complex_t IT_0106 = (-2)*std::conj(IT_0033);
    const complex_t IT_0107 = 0.5*IT_0106;
    const complex_t IT_0108 = std::conj(IT_0062) + std::conj(IT_0105) + IT_0107;
    const complex_t IT_0109 = 0.25*IT_0043 + 0.25*IT_0052 + 0.25*IT_0061;
    const complex_t IT_0110 = 0.25*IT_0076 + 0.25*IT_0085 + (-0.25)*IT_0090 +
       0.25*IT_0099 + (-0.25)*IT_0104;
    const complex_t IT_0111 = s_13*s_24;
    const complex_t IT_0112 = 128*IT_0111;
    const complex_t IT_0113 = s_14*s_23;
    const complex_t IT_0114 = 128*IT_0113;
    const complex_t IT_0115 = (-64)*IT_0000;
    const complex_t IT_0116 = IT_0112 + IT_0114 + IT_0115;
    const complex_t IT_0117 = m_b*m_d*m_t*m_XX;
    const complex_t IT_0118 = 192*IT_0117;
    const complex_t IT_0119 = IT_0116 + IT_0118;
    const complex_t IT_0120 = std::conj(IT_0109) + std::conj(IT_0110);
    const complex_t IT_0121 = (-0.25)*IT_0043 + (-0.25)*IT_0052 + (-0.25)
      *IT_0061;
    const complex_t IT_0122 = (-0.25)*IT_0076 + (-0.25)*IT_0085 + 0.25*IT_0090
       + (-0.25)*IT_0099 + 0.25*IT_0104;
    const complex_t IT_0123 = (-192)*IT_0117;
    const complex_t IT_0124 = IT_0116 + IT_0123;
    const complex_t IT_0125 = std::conj(IT_0121) + std::conj(IT_0122);
    const complex_t IT_0126 = -IT_0111;
    const complex_t IT_0127 = IT_0113 + IT_0126;
    const complex_t IT_0128 = 8*IT_0105;
    const complex_t IT_0129 = 8*std::conj(IT_0105);
    const complex_t IT_0130 = 8*IT_0062;
    const complex_t IT_0131 = (-8)*IT_0033;
    const complex_t IT_0132 = 8*std::conj(IT_0062);
    const complex_t IT_0133 = (-8)*std::conj(IT_0033);
    const complex_t IT_0134 = std::conj(IT_0105)*(IT_0109 + IT_0121) + IT_0105
      *(std::conj(IT_0109) + std::conj(IT_0121)) + 0.125*(std::conj(IT_0110) +
       std::conj(IT_0122))*IT_0128 + 0.125*(IT_0110 + IT_0122)*IT_0129 + 0.125*
      (std::conj(IT_0109) + std::conj(IT_0110) + std::conj(IT_0121) + std::conj
      (IT_0122))*(IT_0130 + IT_0131) + 0.125*(IT_0109 + IT_0110 + IT_0121 +
       IT_0122)*(IT_0132 + IT_0133);
    const complex_t IT_0135 = 2*IT_0000*(IT_0033*(std::conj(IT_0033) + 
      -std::conj(IT_0062) + -std::conj(IT_0105)) + (IT_0062 + IT_0105)*IT_0108) 
      + (IT_0109 + IT_0110)*IT_0119*IT_0120 + (IT_0121 + IT_0122)*IT_0124
      *IT_0125 + 8*IT_0127*IT_0134;
    return IT_0135;
}
