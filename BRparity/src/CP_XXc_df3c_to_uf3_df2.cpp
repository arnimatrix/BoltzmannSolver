...
complex_t CP_XXc_df3c_to_uf3_df2(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0032 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    const complex_t IT_0033 = std::conj(lpp_012)*std::conj(U_utR_00);
    const complex_t IT_0034 = std::conj(lpp_112)*std::conj(U_utR_10);
    const complex_t IT_0035 = std::conj(lpp_212)*std::conj(U_utR_20);
    const complex_t IT_0036 = std::conj(lpp_021)*std::conj(U_utR_00);
    const complex_t IT_0037 = std::conj(lpp_121)*std::conj(U_utR_10);
    const complex_t IT_0038 = std::conj(lpp_221)*std::conj(U_utR_20);
    const complex_t IT_0039 = (complex_t{0, 1})*(IT_0033 + IT_0034 + IT_0035 +
       -IT_0036 + -IT_0037 + -IT_0038);
    const complex_t IT_0040 = (complex_t{0, -1})*gw*gwuR*U_utR_20;
    ...
    const complex_t IT_0046 = std::conj(lpp_012)*std::conj(U_utR_01);
    const complex_t IT_0047 = std::conj(lpp_112)*std::conj(U_utR_11);
    const complex_t IT_0048 = std::conj(lpp_212)*std::conj(U_utR_21);
    const complex_t IT_0049 = std::conj(lpp_021)*std::conj(U_utR_01);
    const complex_t IT_0050 = std::conj(lpp_121)*std::conj(U_utR_11);
    const complex_t IT_0051 = std::conj(lpp_221)*std::conj(U_utR_21);
    const complex_t IT_0052 = (complex_t{0, 1})*(IT_0046 + IT_0047 + IT_0048 +
       -IT_0049 + -IT_0050 + -IT_0051);
    const complex_t IT_0053 = (complex_t{0, -1})*gw*gwuR*U_utR_21;
    ...
    const complex_t IT_0058 = std::conj(lpp_012)*std::conj(U_utR_02);
    const complex_t IT_0059 = std::conj(lpp_112)*std::conj(U_utR_12);
    const complex_t IT_0060 = std::conj(lpp_212)*std::conj(U_utR_22);
    const complex_t IT_0061 = std::conj(lpp_021)*std::conj(U_utR_02);
    const complex_t IT_0062 = std::conj(lpp_121)*std::conj(U_utR_12);
    const complex_t IT_0063 = std::conj(lpp_221)*std::conj(U_utR_22);
    const complex_t IT_0064 = (complex_t{0, 1})*(IT_0058 + IT_0059 + IT_0060 +
       -IT_0061 + -IT_0062 + -IT_0063);
    const complex_t IT_0065 = (complex_t{0, -1})*gw*gwuR*U_utR_22;
    ...
    const complex_t IT_0070 = (-0.25)*IT_0045 + (-0.25)*IT_0057 + (-0.25)
      *IT_0069;
    ...
    const complex_t IT_0078 = m_b*m_s*m_t*m_XX;
    const complex_t IT_0079 = (-192)*IT_0078;
    const complex_t IT_0080 = IT_0077 + IT_0079;
    const complex_t IT_0081 = (-0.25)*IT_0057 + (-0.25)*IT_0069;
    const complex_t IT_0082 = m_s*m_t*s_12;
    const complex_t IT_0083 = m_b*m_XX*s_34;
    const complex_t IT_0084 = 96*IT_0083;
    const complex_t IT_0085 = 192*IT_0078;
    const complex_t IT_0086 = (-64)*IT_0073;
    const complex_t IT_0087 = IT_0076 + 96*IT_0082 + IT_0084 + IT_0085 +
       IT_0086;
    const complex_t IT_0088 = (-0.25)*IT_0045;
    const complex_t IT_0089 = IT_0077 + IT_0085;
    const complex_t IT_0090 = (-64)*IT_0075;
    const complex_t IT_0091 = 64*IT_0073;
    const complex_t IT_0092 = (-96)*IT_0083;
    const complex_t IT_0093 = 128*IT_0071;
    const complex_t IT_0094 = 128*IT_0073;
    const complex_t IT_0095 = IT_0090 + IT_0093 + IT_0094;
    const complex_t IT_0096 = IT_0032*std::conj(IT_0032);
    const complex_t IT_0097 = IT_0079 + IT_0095;
    const complex_t IT_0098 = -IT_0071;
    const complex_t IT_0099 = IT_0073 + IT_0098;
    const complex_t IT_0100 = 0.5*IT_0045 + 0.5*IT_0057 + 0.5*IT_0069;
    const complex_t IT_0101 = std::conj(lpp_201)*std::conj(U_dtR_00);
    const complex_t IT_0102 = std::conj(lpp_210)*std::conj(U_dtR_00);
    const complex_t IT_0103 = std::conj(lpp_212)*std::conj(U_dtR_20);
    const complex_t IT_0104 = std::conj(lpp_221)*std::conj(U_dtR_20);
    const complex_t IT_0105 = (complex_t{0, 1})*(IT_0101 + -IT_0102 + -IT_0103
       + IT_0104);
    const complex_t IT_0106 = (complex_t{0, -1})*gw*gwdR*U_dtR_20;
    const complex_t IT_0107 = IT_0105*IT_0106;
    const complex_t IT_0108 = std::pow(2*s_12 + (complex_t{0, 1})*GdRt*m_dtR1 
      + IT_0007 + -IT_0009 + IT_0042 + reg_prop, -1);
    const complex_t IT_0109 = (complex_t{0, 1})*IT_0107*IT_0108;
    const complex_t IT_0110 = std::conj(lpp_201)*std::conj(U_dtR_01);
    const complex_t IT_0111 = std::conj(lpp_210)*std::conj(U_dtR_01);
    const complex_t IT_0112 = std::conj(lpp_212)*std::conj(U_dtR_21);
    const complex_t IT_0113 = std::conj(lpp_221)*std::conj(U_dtR_21);
    const complex_t IT_0114 = (complex_t{0, 1})*(IT_0110 + -IT_0111 + -IT_0112
       + IT_0113);
    const complex_t IT_0115 = (complex_t{0, -1})*gw*gwdR*U_dtR_21;
    const complex_t IT_0116 = IT_0114*IT_0115;
    const complex_t IT_0117 = std::pow(2*s_12 + (complex_t{0, 1})*GsRt*m_dtR2 
      + IT_0007 + -IT_0019 + IT_0042 + reg_prop, -1);
    const complex_t IT_0118 = (complex_t{0, 1})*IT_0116*IT_0117;
    const complex_t IT_0119 = std::conj(lpp_201)*std::conj(U_dtR_02);
    const complex_t IT_0120 = std::conj(lpp_210)*std::conj(U_dtR_02);
    const complex_t IT_0121 = std::conj(lpp_212)*std::conj(U_dtR_22);
    const complex_t IT_0122 = std::conj(lpp_221)*std::conj(U_dtR_22);
    const complex_t IT_0123 = (complex_t{0, 1})*(IT_0119 + -IT_0120 + -IT_0121
       + IT_0122);
    const complex_t IT_0124 = (complex_t{0, -1})*gw*gwdR*U_dtR_22;
    const complex_t IT_0125 = IT_0123*IT_0124;
    const complex_t IT_0126 = std::pow(2*s_12 + (complex_t{0, 1})*GbRt*m_dtR3 
      + IT_0007 + -IT_0029 + IT_0042 + reg_prop, -1);
    const complex_t IT_0127 = (complex_t{0, 1})*IT_0125*IT_0126;
    const complex_t IT_0128 = IT_0109 + IT_0118 + IT_0127;
    const complex_t IT_0129 = (-0.5)*IT_0011 + (-0.5)*IT_0021 + (-0.5)*IT_0031;
    const complex_t IT_0130 = -std::conj(IT_0129);
    const complex_t IT_0131 = std::conj(IT_0100) + std::conj(IT_0128) + IT_0130;
    const complex_t IT_0132 = (-8)*std::conj(IT_0100);
    const complex_t IT_0133 = -IT_0129;
    const complex_t IT_0134 = std::conj(IT_0032)*(IT_0070*IT_0080 + IT_0081
      *IT_0087 + IT_0088*IT_0089) + IT_0032*(std::conj(IT_0070)*IT_0080 +
       std::conj(IT_0081)*IT_0087 + std::conj(IT_0088)*IT_0089) + (std::conj
      (IT_0081)*IT_0088 + IT_0081*std::conj(IT_0088))*(IT_0079 + (-96)*IT_0082 +
       IT_0090 + IT_0091 + IT_0092) + (IT_0085 + IT_0095)*(IT_0070*std::conj
      (IT_0070) + IT_0096) + (IT_0081*std::conj(IT_0081) + IT_0088*std::conj
      (IT_0088) + IT_0096)*IT_0097 + 8*IT_0099*(IT_0070*IT_0131 + -(IT_0081 +
       IT_0088)*(std::conj(IT_0128) + -std::conj(IT_0129) + (-0.125)*IT_0132) + 
      (std::conj(IT_0070) + -std::conj(IT_0081) + -std::conj(IT_0088))*(IT_0100 
      + IT_0128 + IT_0133)) + 2*IT_0075*IT_0131*(IT_0100 + IT_0128 + IT_0133);
    return IT_0134;
}
