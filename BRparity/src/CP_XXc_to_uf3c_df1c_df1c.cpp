...
complex_t CP_XXc_to_uf3c_df1c_df1c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0041 = 0.25*IT_0036 + 0.25*IT_0038 + 0.25*IT_0040;
    ...
    const complex_t IT_0053 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    const complex_t IT_0054 = 0.25*IT_0011 + 0.25*IT_0021 + 0.25*IT_0031;
    ...
    const complex_t IT_0070 = std::conj(IT_0032)*IT_0052;
    const complex_t IT_0071 = IT_0047*std::conj(IT_0048);
