        ...
        )
{
    ...
    const complex_t IT_0015 = lpp_201*U_dtR_11;
    const complex_t IT_0016 = lpp_202*U_dtR_21;
    const complex_t IT_0017 = IT_0015 + IT_0016;
    const complex_t IT_0018 = lpp_210*U_dtR_11;
    const complex_t IT_0019 = lpp_220*U_dtR_21;
    ...
    const complex_t IT_0027 = lpp_201*U_dtR_12;
    const complex_t IT_0028 = lpp_202*U_dtR_22;
    const complex_t IT_0029 = IT_0027 + IT_0028;
    const complex_t IT_0030 = lpp_210*U_dtR_12;
    const complex_t IT_0031 = lpp_220*U_dtR_22;
    ...
    const complex_t IT_0041 = gw*gwuR*std::conj(U_utR_20);
    const complex_t IT_0042 = lpp_020*U_utR_00;
    const complex_t IT_0043 = lpp_120*U_utR_10;
    const complex_t IT_0044 = lpp_220*U_utR_20;
    const complex_t IT_0045 = IT_0042 + IT_0043 + IT_0044;
    const complex_t IT_0046 = lpp_002*U_utR_00;
    const complex_t IT_0047 = lpp_102*U_utR_10;
    const complex_t IT_0048 = lpp_202*U_utR_20;
    ...
    const complex_t IT_0057 = gw*gwuR*std::conj(U_utR_21);
    const complex_t IT_0058 = lpp_020*U_utR_01;
    const complex_t IT_0059 = lpp_120*U_utR_11;
    const complex_t IT_0060 = lpp_220*U_utR_21;
    const complex_t IT_0061 = IT_0058 + IT_0059 + IT_0060;
    const complex_t IT_0062 = lpp_002*U_utR_01;
    const complex_t IT_0063 = lpp_102*U_utR_11;
    const complex_t IT_0064 = lpp_202*U_utR_21;
    ...
    const complex_t IT_0072 = gw*gwuR*std::conj(U_utR_22);
    const complex_t IT_0073 = lpp_020*U_utR_02;
    const complex_t IT_0074 = lpp_120*U_utR_12;
    const complex_t IT_0075 = lpp_220*U_utR_22;
    const complex_t IT_0076 = IT_0073 + IT_0074 + IT_0075;
    const complex_t IT_0077 = lpp_002*U_utR_02;
    const complex_t IT_0078 = lpp_102*U_utR_12;
    const complex_t IT_0079 = lpp_202*U_utR_22;
    ...
    const complex_t IT_0092 = IT_0088 + IT_0091;
    const complex_t IT_0093 = lpp_202*U_dtR_00;
    const complex_t IT_0094 = lpp_212*U_dtR_10;
    const complex_t IT_0095 = IT_0093 + IT_0094;
    const complex_t IT_0096 = lpp_220*U_dtR_00;
    const complex_t IT_0097 = lpp_221*U_dtR_10;
    const complex_t IT_0098 = -IT_0096 + -IT_0097;
    const complex_t IT_0099 = IT_0095 + IT_0098;
    const complex_t IT_0100 = gw*gwdR*std::conj(U_dtR_00);
    const complex_t IT_0101 = IT_0099*IT_0100;
    const complex_t IT_0102 = std::pow(m_d, 2);
    const complex_t IT_0103 = std::pow((-2)*s_25 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0011 + -IT_0012 + IT_0102, -1);
    const complex_t IT_0104 = (complex_t{0, 1})*IT_0101*IT_0103;
    const complex_t IT_0105 = lpp_202*U_dtR_01;
    const complex_t IT_0106 = lpp_212*U_dtR_11;
    const complex_t IT_0107 = IT_0105 + IT_0106;
    const complex_t IT_0108 = lpp_220*U_dtR_01;
    const complex_t IT_0109 = lpp_221*U_dtR_11;
    const complex_t IT_0110 = -IT_0108 + -IT_0109;
    const complex_t IT_0111 = IT_0107 + IT_0110;
    const complex_t IT_0112 = gw*gwdR*std::conj(U_dtR_01);
    const complex_t IT_0113 = IT_0111*IT_0112;
    const complex_t IT_0114 = std::pow((-2)*s_25 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0011 + -IT_0024 + IT_0102, -1);
    const complex_t IT_0115 = (complex_t{0, 1})*IT_0113*IT_0114;
    const complex_t IT_0116 = lpp_202*U_dtR_02;
    const complex_t IT_0117 = lpp_212*U_dtR_12;
    const complex_t IT_0118 = IT_0116 + IT_0117;
    const complex_t IT_0119 = lpp_220*U_dtR_02;
    const complex_t IT_0120 = lpp_221*U_dtR_12;
    const complex_t IT_0121 = -IT_0119 + -IT_0120;
    const complex_t IT_0122 = IT_0118 + IT_0121;
    const complex_t IT_0123 = gw*gwdR*std::conj(U_dtR_02);
    const complex_t IT_0124 = IT_0122*IT_0123;
    const complex_t IT_0125 = std::pow((-2)*s_25 + (complex_t{0, 1})*GbRt
    ...
    const complex_t IT_0128 = -IT_0088;
    const complex_t IT_0129 = IT_0091 + IT_0128;
    const complex_t IT_0130 = -std::conj(IT_0039);
    const complex_t IT_0131 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + (-0.5)
      *std::conj(IT_0087)*IT_0092 + (-0.5)*std::conj(IT_0127)*(IT_0040 + IT_0089
       + IT_0128)) + 2*IT_0087*(std::conj(IT_0087)*IT_0088 + 0.5*std::conj
      (IT_0127)*IT_0129 + 0.5*IT_0092*IT_0130) + 2*IT_0127*(IT_0089*std::conj
      (IT_0127) + 0.5*std::conj(IT_0087)*IT_0129 + 0.5*(IT_0040 + IT_0089 +
       IT_0128)*IT_0130);
    return IT_0131;
}
