        ...
        )
{
    ...
    const complex_t IT_0004 = std::conj(lpp_020)*std::conj(U_utR_00);
    const complex_t IT_0005 = std::conj(lpp_120)*std::conj(U_utR_10);
    const complex_t IT_0006 = std::conj(lpp_220)*std::conj(U_utR_20);
    ...
    const complex_t IT_0018 = std::conj(lpp_002)*std::conj(U_utR_01);
    const complex_t IT_0019 = std::conj(lpp_102)*std::conj(U_utR_11);
    const complex_t IT_0020 = std::conj(lpp_202)*std::conj(U_utR_21);
    const complex_t IT_0021 = IT_0018 + IT_0019 + IT_0020;
    const complex_t IT_0022 = std::conj(lpp_020)*std::conj(U_utR_01);
    const complex_t IT_0023 = std::conj(lpp_120)*std::conj(U_utR_11);
    const complex_t IT_0024 = std::conj(lpp_220)*std::conj(U_utR_21);
    ...
    const complex_t IT_0033 = std::conj(lpp_002)*std::conj(U_utR_02);
    const complex_t IT_0034 = std::conj(lpp_102)*std::conj(U_utR_12);
    const complex_t IT_0035 = std::conj(lpp_202)*std::conj(U_utR_22);
    const complex_t IT_0036 = IT_0033 + IT_0034 + IT_0035;
    const complex_t IT_0037 = std::conj(lpp_020)*std::conj(U_utR_02);
    const complex_t IT_0038 = std::conj(lpp_120)*std::conj(U_utR_12);
    const complex_t IT_0039 = std::conj(lpp_220)*std::conj(U_utR_22);
    ...
    const complex_t IT_0057 = gw*gwdR*U_dtR_20;
    const complex_t IT_0058 = IT_0056*IT_0057;
    const complex_t IT_0059 = std::pow(m_b, 2);
    ...
    const complex_t IT_0070 = gw*gwdR*U_dtR_21;
    ...
    const complex_t IT_0082 = gw*gwdR*U_dtR_22;
    ...
    const complex_t IT_0091 = IT_0049 + IT_0090;
    const complex_t IT_0092 = std::conj(lpp_202)*std::conj(U_dtR_00);
    const complex_t IT_0093 = std::conj(lpp_212)*std::conj(U_dtR_10);
    const complex_t IT_0094 = IT_0092 + IT_0093;
    const complex_t IT_0095 = std::conj(lpp_220)*std::conj(U_dtR_00);
    const complex_t IT_0096 = std::conj(lpp_221)*std::conj(U_dtR_10);
    ...
    const complex_t IT_0104 = std::conj(lpp_202)*std::conj(U_dtR_01);
    const complex_t IT_0105 = std::conj(lpp_212)*std::conj(U_dtR_11);
    const complex_t IT_0106 = IT_0104 + IT_0105;
    const complex_t IT_0107 = std::conj(lpp_220)*std::conj(U_dtR_01);
    const complex_t IT_0108 = std::conj(lpp_221)*std::conj(U_dtR_11);
    ...
    const complex_t IT_0115 = std::conj(lpp_202)*std::conj(U_dtR_02);
    const complex_t IT_0116 = std::conj(lpp_212)*std::conj(U_dtR_12);
    const complex_t IT_0117 = IT_0115 + IT_0116;
    const complex_t IT_0118 = std::conj(lpp_220)*std::conj(U_dtR_02);
    const complex_t IT_0119 = std::conj(lpp_221)*std::conj(U_dtR_12);
    ...
    const complex_t IT_0128 = IT_0049 + IT_0089 + IT_0127;
    ...
    const complex_t IT_0132 = IT_0048*(12*std::conj(IT_0048)*IT_0049 + 6
      *std::conj(IT_0087)*(IT_0088 + IT_0091) + std::conj(IT_0126)*IT_0129) +
       IT_0126*(12*IT_0089*std::conj(IT_0126) + std::conj(IT_0048)*IT_0129 +
       std::conj(IT_0087)*IT_0131) + IT_0087*(12*std::conj(IT_0087)*IT_0088 + 6
      *std::conj(IT_0048)*(IT_0088 + IT_0091) + std::conj(IT_0126)*IT_0131);
    return IT_0132;
}
