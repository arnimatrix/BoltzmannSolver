        ...
        )
{
    ...
    const complex_t IT_0109 = lpp_102*U_dtR_00;
    const complex_t IT_0110 = lpp_112*U_dtR_10;
    const complex_t IT_0111 = IT_0109 + IT_0110;
    const complex_t IT_0112 = lpp_120*U_dtR_00;
    const complex_t IT_0113 = lpp_121*U_dtR_10;
    ...
    const complex_t IT_0120 = lpp_102*U_dtR_02;
    const complex_t IT_0121 = lpp_112*U_dtR_12;
    const complex_t IT_0122 = IT_0120 + IT_0121;
    const complex_t IT_0123 = lpp_120*U_dtR_02;
    const complex_t IT_0124 = lpp_121*U_dtR_12;
