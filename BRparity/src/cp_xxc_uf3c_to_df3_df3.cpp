...
complex_t CP_XXc_uf3c_to_df3_df3(
        param_t const &param
        )
{
    clearcache();
    ...
    return IT_0047*(std::conj(IT_0047)*IT_0048 + std::conj(IT_0039)*IT_0051) +
       IT_0039*(std::conj(IT_0039)*IT_0040 + std::conj(IT_0047)*IT_0051);
}
