...
complex_t CP_XXc_to_uf2_df2_df2(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0042 = std::pow((-2)*s_13 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0008 + -IT_0009 + IT_0041 + reg_prop, -1);
    ...
    const complex_t IT_0058 = m_c*m_XX*IT_0008;
    ...
    const complex_t IT_0064 = m_c*m_XX*s_34;
    const complex_t IT_0065 = (-288)*IT_0064;
    const complex_t IT_0066 = s_12*IT_0008;
