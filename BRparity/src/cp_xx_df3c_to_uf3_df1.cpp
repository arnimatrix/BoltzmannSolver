        ...
        )
{
    ...
    const complex_t IT_0093 = -IT_0040;
    const complex_t IT_0094 = IT_0091 + IT_0093;
    const complex_t IT_0095 = std::conj(lpp_202)*std::conj(U_dtR_00);
    const complex_t IT_0096 = std::conj(lpp_212)*std::conj(U_dtR_10);
    const complex_t IT_0097 = IT_0095 + IT_0096;
    const complex_t IT_0098 = std::conj(lpp_220)*std::conj(U_dtR_00);
    const complex_t IT_0099 = std::conj(lpp_221)*std::conj(U_dtR_10);
    const complex_t IT_0100 = -IT_0098 + -IT_0099;
    const complex_t IT_0101 = IT_0097 + IT_0100;
    const complex_t IT_0102 = gw*gwdR*U_dtR_00;
    const complex_t IT_0103 = IT_0101*IT_0102;
    const complex_t IT_0104 = std::pow(m_d, 2);
    const complex_t IT_0105 = std::pow((-2)*s_25 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0011 + -IT_0012 + IT_0104, -1);
    const complex_t IT_0106 = (complex_t{0, 1})*IT_0103*IT_0105;
    const complex_t IT_0107 = std::conj(lpp_202)*std::conj(U_dtR_01);
    const complex_t IT_0108 = std::conj(lpp_212)*std::conj(U_dtR_11);
    const complex_t IT_0109 = IT_0107 + IT_0108;
    const complex_t IT_0110 = std::conj(lpp_220)*std::conj(U_dtR_01);
    const complex_t IT_0111 = std::conj(lpp_221)*std::conj(U_dtR_11);
    const complex_t IT_0112 = -IT_0110 + -IT_0111;
    const complex_t IT_0113 = IT_0109 + IT_0112;
    const complex_t IT_0114 = gw*gwdR*U_dtR_01;
    const complex_t IT_0115 = IT_0113*IT_0114;
    const complex_t IT_0116 = std::pow((-2)*s_25 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0011 + -IT_0024 + IT_0104, -1);
    const complex_t IT_0117 = (complex_t{0, 1})*IT_0115*IT_0116;
    const complex_t IT_0118 = std::conj(lpp_202)*std::conj(U_dtR_02);
    const complex_t IT_0119 = std::conj(lpp_212)*std::conj(U_dtR_12);
    const complex_t IT_0120 = IT_0118 + IT_0119;
    const complex_t IT_0121 = std::conj(lpp_220)*std::conj(U_dtR_02);
    const complex_t IT_0122 = std::conj(lpp_221)*std::conj(U_dtR_12);
    const complex_t IT_0123 = -IT_0121 + -IT_0122;
    const complex_t IT_0124 = IT_0120 + IT_0123;
    const complex_t IT_0125 = gw*gwdR*U_dtR_02;
    const complex_t IT_0126 = IT_0124*IT_0125;
    const complex_t IT_0127 = std::pow((-2)*s_25 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0011 + -IT_0036 + IT_0104, -1);
    const complex_t IT_0128 = (complex_t{0, 1})*IT_0126*IT_0127;
    const complex_t IT_0129 = IT_0106 + IT_0117 + IT_0128;
    const complex_t IT_0130 = 0.5*std::conj(IT_0129);
    const complex_t IT_0131 = 0.5*std::conj(IT_0039);
    const complex_t IT_0132 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + 0.5
      *std::conj(IT_0087)*IT_0092 + IT_0094*IT_0130) + 2*IT_0087*(std::conj
      (IT_0087)*IT_0088 + (IT_0088 + IT_0089 + IT_0093)*IT_0130 + IT_0092
      *IT_0131) + 2*IT_0129*(0.5*std::conj(IT_0087)*(IT_0088 + IT_0089 + IT_0093
      ) + IT_0089*std::conj(IT_0129) + IT_0094*IT_0131);
    return IT_0132;
}
