...
complex_t CP_utR3_to_df1c_df3c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0000 = lpp_002*U_utR_02;
    const complex_t IT_0001 = lpp_102*U_utR_12;
    const complex_t IT_0002 = lpp_202*U_utR_22;
    const complex_t IT_0003 = (complex_t{0, 1})*(IT_0000 + IT_0001 + IT_0002);
    const complex_t IT_0004 = -IT_0003;
    const complex_t IT_0005 = lpp_020*U_utR_02;
    const complex_t IT_0006 = lpp_120*U_utR_12;
    const complex_t IT_0007 = lpp_220*U_utR_22;
