        ...
        )
{
    ...
    const complex_t IT_0033 = lpp_102*U_dtR_00;
    const complex_t IT_0034 = lpp_112*U_dtR_10;
    const complex_t IT_0035 = lpp_120*U_dtR_00;
    const complex_t IT_0036 = lpp_121*U_dtR_10;
    const complex_t IT_0037 = (complex_t{0, 1})*(IT_0033 + IT_0034 + -IT_0035 
      + -IT_0036);
    const complex_t IT_0038 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_10);
    const complex_t IT_0039 = IT_0037*IT_0038;
    const complex_t IT_0040 = std::pow(m_c, 2);
    ...
    const complex_t IT_0043 = lpp_102*U_dtR_01;
    const complex_t IT_0044 = lpp_112*U_dtR_11;
    const complex_t IT_0045 = lpp_120*U_dtR_01;
    const complex_t IT_0046 = lpp_121*U_dtR_11;
    const complex_t IT_0047 = (complex_t{0, 1})*(IT_0043 + IT_0044 + -IT_0045 
      + -IT_0046);
    const complex_t IT_0048 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_11);
    ...
    const complex_t IT_0052 = lpp_102*U_dtR_02;
    const complex_t IT_0053 = lpp_112*U_dtR_12;
    const complex_t IT_0054 = lpp_120*U_dtR_02;
    const complex_t IT_0055 = lpp_121*U_dtR_12;
    const complex_t IT_0056 = (complex_t{0, 1})*(IT_0052 + IT_0053 + -IT_0054 
      + -IT_0055);
    const complex_t IT_0057 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_12);
    ...
    const complex_t IT_0064 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_10);
    const complex_t IT_0065 = (complex_t{0, 1})*IT_0063*IT_0064;
    const complex_t IT_0066 = lpp_021*U_utR_00;
    const complex_t IT_0067 = lpp_121*U_utR_10;
    const complex_t IT_0068 = lpp_221*U_utR_20;
    const complex_t IT_0069 = (complex_t{0, 1})*(IT_0066 + IT_0067 + IT_0068);
    const complex_t IT_0070 = lpp_012*U_utR_00;
    const complex_t IT_0071 = lpp_112*U_utR_10;
    const complex_t IT_0072 = lpp_212*U_utR_20;
    ...
    const complex_t IT_0078 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_11);
    const complex_t IT_0079 = (complex_t{0, 1})*IT_0077*IT_0078;
    const complex_t IT_0080 = lpp_021*U_utR_01;
    const complex_t IT_0081 = lpp_121*U_utR_11;
    const complex_t IT_0082 = lpp_221*U_utR_21;
    const complex_t IT_0083 = (complex_t{0, 1})*(IT_0080 + IT_0081 + IT_0082);
    const complex_t IT_0084 = IT_0079*IT_0083;
    const complex_t IT_0085 = lpp_012*U_utR_01;
    const complex_t IT_0086 = lpp_112*U_utR_11;
    const complex_t IT_0087 = lpp_212*U_utR_21;
    ...
    const complex_t IT_0092 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_12);
    const complex_t IT_0093 = (complex_t{0, 1})*IT_0091*IT_0092;
    const complex_t IT_0094 = lpp_021*U_utR_02;
    const complex_t IT_0095 = lpp_121*U_utR_12;
    const complex_t IT_0096 = lpp_221*U_utR_22;
    const complex_t IT_0097 = (complex_t{0, 1})*(IT_0094 + IT_0095 + IT_0096);
    const complex_t IT_0098 = IT_0093*IT_0097;
    const complex_t IT_0099 = lpp_012*U_utR_02;
    const complex_t IT_0100 = lpp_112*U_utR_12;
    const complex_t IT_0101 = lpp_212*U_utR_22;
    ...
    const complex_t IT_0125 = m_b*m_c*m_s*m_XX;
