...
complex_t CP_XXc_df3_to_uf3c_df3c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0047 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    const complex_t IT_0048 = 0.25*IT_0011 + 0.25*IT_0021 + 0.25*IT_0031;
    const complex_t IT_0049 = (-8)*std::conj(IT_0032);
    const complex_t IT_0050 = 0.125*IT_0049;
    const complex_t IT_0051 = std::conj(IT_0040) + IT_0050;
    const complex_t IT_0052 = m_t*m_XX*IT_0007;
    const complex_t IT_0053 = 128*IT_0044;
    const complex_t IT_0054 = (-64)*IT_0041;
    const complex_t IT_0055 = 128*IT_0043;
    const complex_t IT_0056 = 2*(IT_0032 + -IT_0040)*IT_0041*IT_0042 + (-8)
      *IT_0046*((IT_0032 + -IT_0040)*(std::conj(IT_0047) + std::conj(IT_0048)) +
       -(IT_0047 + IT_0048)*IT_0051) + IT_0047*std::conj(IT_0047)*(192*IT_0052 +
       IT_0053 + IT_0054 + IT_0055) + IT_0048*std::conj(IT_0048)*((-192)*IT_0052
       + IT_0053 + IT_0054 + IT_0055);
    return IT_0056;
}
