...
complex_t CP_XX_uf2_to_df2c_df3c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0079 = IT_0040 + IT_0076 + IT_0078;
    ...
    const complex_t IT_0133 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + 0.5
      *std::conj(IT_0075)*IT_0080 + 0.5*std::conj(IT_0127)*IT_0131) + 2*IT_0075*
      (std::conj(IT_0075)*IT_0076 + 0.5*std::conj(IT_0127)*(IT_0077 + IT_0129) +
       IT_0080*IT_0132) + 2*IT_0127*(IT_0077*std::conj(IT_0127) + 0.5*std::conj
      (IT_0075)*(IT_0077 + IT_0129) + IT_0131*IT_0132);
    return IT_0133;
}
