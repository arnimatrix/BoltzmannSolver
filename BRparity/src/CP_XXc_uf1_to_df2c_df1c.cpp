        ...
        )
{
    ...
    const complex_t IT_0085 = (complex_t{0, -1})*(IT_0081 + IT_0082 + -IT_0083
       + -IT_0084);
    const complex_t IT_0086 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_10);
    ...
    const complex_t IT_0094 = (complex_t{0, -1})*(IT_0090 + IT_0091 + -IT_0092
       + -IT_0093);
    const complex_t IT_0095 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_11);
    ...
    const complex_t IT_0103 = (complex_t{0, -1})*(IT_0099 + IT_0100 + -IT_0101
       + -IT_0102);
    const complex_t IT_0104 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_12);
