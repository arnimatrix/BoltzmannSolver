...
complex_t CP_XX_to_uf2_df2_df1(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0001 = std::conj(lpp_110)*std::conj(U_dtR_00);
    const complex_t IT_0002 = std::conj(lpp_112)*std::conj(U_dtR_20);
    const complex_t IT_0003 = std::conj(lpp_121)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0012 = std::conj(lpp_101)*std::conj(U_dtR_01);
    const complex_t IT_0013 = std::conj(lpp_110)*std::conj(U_dtR_01);
    const complex_t IT_0014 = std::conj(lpp_112)*std::conj(U_dtR_21);
    const complex_t IT_0015 = std::conj(lpp_121)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0022 = std::conj(lpp_101)*std::conj(U_dtR_02);
    const complex_t IT_0023 = std::conj(lpp_110)*std::conj(U_dtR_02);
    const complex_t IT_0024 = std::conj(lpp_112)*std::conj(U_dtR_22);
    const complex_t IT_0025 = std::conj(lpp_121)*std::conj(U_dtR_22);
    ...
    const complex_t IT_0035 = std::conj(lpp_001)*std::conj(U_utR_00);
    const complex_t IT_0036 = std::conj(lpp_101)*std::conj(U_utR_10);
    const complex_t IT_0037 = std::conj(lpp_201)*std::conj(U_utR_20);
    const complex_t IT_0038 = std::conj(lpp_010)*std::conj(U_utR_00);
    const complex_t IT_0039 = std::conj(lpp_110)*std::conj(U_utR_10);
    const complex_t IT_0040 = std::conj(lpp_210)*std::conj(U_utR_20);
    const complex_t IT_0041 = (complex_t{0, 1})*(IT_0035 + IT_0036 + IT_0037 +
       -IT_0038 + -IT_0039 + -IT_0040);
    const complex_t IT_0042 = (complex_t{0, -1})*gw*gwuR*U_utR_10;
    ...
    const complex_t IT_0046 = std::pow((-2)*s_12 + (complex_t{0, 1})*GuRt
      *m_utR1 + IT_0007 + IT_0044 + -IT_0045 + reg_prop, -1);
    const complex_t IT_0047 = (complex_t{0, 1})*IT_0043*IT_0046;
    const complex_t IT_0048 = std::conj(lpp_001)*std::conj(U_utR_01);
    const complex_t IT_0049 = std::conj(lpp_101)*std::conj(U_utR_11);
    const complex_t IT_0050 = std::conj(lpp_201)*std::conj(U_utR_21);
    const complex_t IT_0051 = std::conj(lpp_010)*std::conj(U_utR_01);
    const complex_t IT_0052 = std::conj(lpp_110)*std::conj(U_utR_11);
    const complex_t IT_0053 = std::conj(lpp_210)*std::conj(U_utR_21);
    const complex_t IT_0054 = (complex_t{0, 1})*(IT_0048 + IT_0049 + IT_0050 +
       -IT_0051 + -IT_0052 + -IT_0053);
    const complex_t IT_0055 = (complex_t{0, -1})*gw*gwuR*U_utR_11;
    ...
    const complex_t IT_0058 = std::pow((-2)*s_12 + (complex_t{0, 1})*GcRt
      *m_utR2 + IT_0007 + IT_0044 + -IT_0057 + reg_prop, -1);
    const complex_t IT_0059 = (complex_t{0, 1})*IT_0056*IT_0058;
    const complex_t IT_0060 = std::conj(lpp_001)*std::conj(U_utR_02);
    const complex_t IT_0061 = std::conj(lpp_101)*std::conj(U_utR_12);
    const complex_t IT_0062 = std::conj(lpp_201)*std::conj(U_utR_22);
    const complex_t IT_0063 = std::conj(lpp_010)*std::conj(U_utR_02);
    const complex_t IT_0064 = std::conj(lpp_110)*std::conj(U_utR_12);
    const complex_t IT_0065 = std::conj(lpp_210)*std::conj(U_utR_22);
    const complex_t IT_0066 = (complex_t{0, 1})*(IT_0060 + IT_0061 + IT_0062 +
       -IT_0063 + -IT_0064 + -IT_0065);
    const complex_t IT_0067 = (complex_t{0, -1})*gw*gwuR*U_utR_12;
    ...
    const complex_t IT_0070 = std::pow((-2)*s_12 + (complex_t{0, 1})*GtRt
      *m_utR3 + IT_0007 + IT_0044 + -IT_0069 + reg_prop, -1);
    const complex_t IT_0071 = (complex_t{0, 1})*IT_0068*IT_0070;
    const complex_t IT_0072 = IT_0047 + IT_0059 + IT_0071;
    const complex_t IT_0073 = std::conj(lpp_101)*std::conj(U_dtR_10);
    const complex_t IT_0074 = std::conj(lpp_102)*std::conj(U_dtR_20);
    const complex_t IT_0075 = std::conj(lpp_110)*std::conj(U_dtR_10);
    const complex_t IT_0076 = std::conj(lpp_120)*std::conj(U_dtR_20);
    const complex_t IT_0077 = (complex_t{0, -1})*(IT_0073 + IT_0074 + -IT_0075
       + -IT_0076);
    const complex_t IT_0078 = (complex_t{0, -1})*gw*gwdR*U_dtR_10;
    const complex_t IT_0079 = IT_0077*IT_0078;
    const complex_t IT_0080 = std::pow((-2)*s_13 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0008 + -IT_0009 + IT_0044 + reg_prop, -1);
    const complex_t IT_0081 = (complex_t{0, 1})*IT_0079*IT_0080;
    const complex_t IT_0082 = std::conj(lpp_101)*std::conj(U_dtR_11);
    const complex_t IT_0083 = std::conj(lpp_102)*std::conj(U_dtR_21);
    const complex_t IT_0084 = std::conj(lpp_110)*std::conj(U_dtR_11);
    const complex_t IT_0085 = std::conj(lpp_120)*std::conj(U_dtR_21);
    const complex_t IT_0086 = (complex_t{0, -1})*(IT_0082 + IT_0083 + -IT_0084
       + -IT_0085);
    const complex_t IT_0087 = (complex_t{0, -1})*gw*gwdR*U_dtR_11;
    const complex_t IT_0088 = IT_0086*IT_0087;
    const complex_t IT_0089 = std::pow((-2)*s_13 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0008 + -IT_0019 + IT_0044 + reg_prop, -1);
    const complex_t IT_0090 = (complex_t{0, 1})*IT_0088*IT_0089;
    const complex_t IT_0091 = std::conj(lpp_101)*std::conj(U_dtR_12);
    const complex_t IT_0092 = std::conj(lpp_102)*std::conj(U_dtR_22);
    const complex_t IT_0093 = std::conj(lpp_110)*std::conj(U_dtR_12);
    const complex_t IT_0094 = std::conj(lpp_120)*std::conj(U_dtR_22);
    const complex_t IT_0095 = (complex_t{0, -1})*(IT_0091 + IT_0092 + -IT_0093
       + -IT_0094);
    const complex_t IT_0096 = (complex_t{0, -1})*gw*gwdR*U_dtR_12;
    const complex_t IT_0097 = IT_0095*IT_0096;
    const complex_t IT_0098 = std::pow((-2)*s_13 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0008 + -IT_0029 + IT_0044 + reg_prop, -1);
    ...
    const complex_t IT_0132 = 384*IT_0033;
    const complex_t IT_0127 = m_c*m_XX*s_34;
    const complex_t IT_0128 = (-576)*IT_0127;
    const complex_t IT_0129 = m_d*m_s*s_12;
    const complex_t IT_0130 = 576*IT_0129;
    const complex_t IT_0131 = (-384)*IT_0108;
    const complex_t IT_0133 = IT_0123 + IT_0128 + IT_0130 + IT_0131 + IT_0132;
    const complex_t IT_0134 = (-768)*IT_0106;
    const complex_t IT_0135 = IT_0032*IT_0110;
    const complex_t IT_0136 = IT_0032*IT_0115;
    const complex_t IT_0137 = IT_0072*IT_0115;
    const complex_t IT_0138 = IT_0100*IT_0110;
    const complex_t IT_0139 = IT_0032*IT_0102;
    const complex_t IT_0140 = IT_0034*IT_0101;
    const complex_t IT_0141 = std::conj(IT_0032)*(IT_0032*IT_0034 + IT_0101
      *IT_0102) + IT_0105*(IT_0111 + IT_0112 + IT_0116 + IT_0117) + std::conj
      (IT_0104)*(IT_0072*IT_0110 + IT_0100*IT_0115 + IT_0104*(IT_0124 + IT_0126)
       + IT_0103*((-768)*IT_0108 + IT_0125 + IT_0132 + IT_0133 + IT_0134) +
       IT_0135 + IT_0136 + IT_0137 + IT_0138) + std::conj(IT_0103)*(IT_0072
      *IT_0110 + IT_0100*IT_0115 + IT_0103*(IT_0124 + IT_0126) + IT_0104*((-768)
      *IT_0108 + IT_0125 + IT_0132 + IT_0133 + IT_0134) + IT_0135 + IT_0136 +
       IT_0137 + IT_0138) + std::conj(IT_0072)*(IT_0139 + IT_0140) + std::conj
      (IT_0100)*(IT_0105*(IT_0110 + IT_0115) + IT_0139 + IT_0140);
    return IT_0141;
}
