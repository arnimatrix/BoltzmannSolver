        ...
        )
{
    ...
    const complex_t IT_0040 = (complex_t{0, -1})*gw*gwuR*U_utR_21;
    ...
    const complex_t IT_0053 = (complex_t{0, -1})*gw*gwuR*U_utR_22;
    ...
    const complex_t IT_0084 = (complex_t{0, -1})*gw*gwuR*U_utR_20;
    ...
    const complex_t IT_0032 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    const complex_t IT_0064 = m_d*m_s*m_t*m_XX;
    ...
    const complex_t IT_0059 = m_d*m_t*s_12;
    ...
    const complex_t IT_0096 = std::conj(lpp_201)*std::conj(U_dtR_10);
    const complex_t IT_0097 = std::conj(lpp_202)*std::conj(U_dtR_20);
    const complex_t IT_0098 = std::conj(lpp_210)*std::conj(U_dtR_10);
    const complex_t IT_0099 = std::conj(lpp_220)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0114 = std::conj(lpp_201)*std::conj(U_dtR_12);
    const complex_t IT_0115 = std::conj(lpp_202)*std::conj(U_dtR_22);
    const complex_t IT_0116 = std::conj(lpp_210)*std::conj(U_dtR_12);
    const complex_t IT_0117 = std::conj(lpp_220)*std::conj(U_dtR_22);
