        ...
        )
{
    ...
    const complex_t IT_0032 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    const complex_t IT_0033 = lpp_021*U_utR_01;
    const complex_t IT_0034 = lpp_121*U_utR_11;
    const complex_t IT_0035 = lpp_221*U_utR_21;
    ...
    const complex_t IT_0043 = lpp_012*U_utR_01;
    const complex_t IT_0044 = lpp_112*U_utR_11;
    const complex_t IT_0045 = lpp_212*U_utR_21;
    const complex_t IT_0046 = (complex_t{0, 1})*(IT_0043 + IT_0044 + IT_0045);
    const complex_t IT_0047 = IT_0041*IT_0046;
    const complex_t IT_0048 = lpp_021*U_utR_02;
    const complex_t IT_0049 = lpp_121*U_utR_12;
    const complex_t IT_0050 = lpp_221*U_utR_22;
    ...
    const complex_t IT_0057 = lpp_012*U_utR_02;
    const complex_t IT_0058 = lpp_112*U_utR_12;
    const complex_t IT_0059 = lpp_212*U_utR_22;
    ...
    const complex_t IT_0077 = m_s*m_t*s_12;
    const complex_t IT_0078 = m_b*m_XX*s_34;
    const complex_t IT_0079 = 96*IT_0078;
    const complex_t IT_0080 = m_b*m_s*m_t*m_XX;
    ...
    const complex_t IT_0095 = lpp_210*U_dtR_00;
    const complex_t IT_0096 = lpp_212*U_dtR_20;
    const complex_t IT_0097 = lpp_221*U_dtR_20;
    ...
    const complex_t IT_0103 = lpp_201*U_dtR_01;
    const complex_t IT_0104 = lpp_210*U_dtR_01;
    const complex_t IT_0105 = lpp_212*U_dtR_21;
    const complex_t IT_0106 = lpp_221*U_dtR_21;
    ...
    const complex_t IT_0112 = lpp_201*U_dtR_02;
    const complex_t IT_0113 = lpp_210*U_dtR_02;
    const complex_t IT_0114 = lpp_212*U_dtR_22;
    const complex_t IT_0115 = lpp_221*U_dtR_22;
