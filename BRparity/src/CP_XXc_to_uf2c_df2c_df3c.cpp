        ...
        )
{
    ...
    const complex_t IT_0034 = lpp_101*U_dtR_00;
    const complex_t IT_0035 = lpp_110*U_dtR_00;
    const complex_t IT_0036 = lpp_112*U_dtR_20;
    const complex_t IT_0037 = lpp_121*U_dtR_20;
    ...
    const complex_t IT_0041 = std::pow(m_c, 2);
    ...
    const complex_t IT_0044 = lpp_101*U_dtR_01;
    const complex_t IT_0045 = lpp_110*U_dtR_01;
    const complex_t IT_0046 = lpp_112*U_dtR_21;
    const complex_t IT_0047 = lpp_121*U_dtR_21;
    ...
    const complex_t IT_0053 = lpp_101*U_dtR_02;
    const complex_t IT_0054 = lpp_110*U_dtR_02;
    const complex_t IT_0055 = lpp_112*U_dtR_22;
    const complex_t IT_0056 = lpp_121*U_dtR_22;
    ...
    const complex_t IT_0069 = lpp_012*U_utR_00;
    const complex_t IT_0070 = lpp_112*U_utR_10;
    const complex_t IT_0071 = lpp_212*U_utR_20;
    const complex_t IT_0072 = (complex_t{0, 1})*(IT_0069 + IT_0070 + IT_0071);
    const complex_t IT_0073 = -IT_0072;
    const complex_t IT_0074 = lpp_021*U_utR_00;
    const complex_t IT_0075 = lpp_121*U_utR_10;
    const complex_t IT_0076 = lpp_221*U_utR_20;
    const complex_t IT_0077 = (complex_t{0, 1})*(IT_0074 + IT_0075 + IT_0076);
    const complex_t IT_0078 = IT_0073 + IT_0077;
    const complex_t IT_0079 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_10);
    ...
    const complex_t IT_0084 = lpp_012*U_utR_01;
    const complex_t IT_0085 = lpp_112*U_utR_11;
    const complex_t IT_0086 = lpp_212*U_utR_21;
    const complex_t IT_0087 = (complex_t{0, 1})*(IT_0084 + IT_0085 + IT_0086);
    const complex_t IT_0088 = -IT_0087;
    const complex_t IT_0089 = lpp_021*U_utR_01;
    const complex_t IT_0090 = lpp_121*U_utR_11;
    const complex_t IT_0091 = lpp_221*U_utR_21;
    const complex_t IT_0092 = (complex_t{0, 1})*(IT_0089 + IT_0090 + IT_0091);
    const complex_t IT_0093 = IT_0088 + IT_0092;
    const complex_t IT_0094 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_11);
    ...
    const complex_t IT_0104 = lpp_021*U_utR_02;
    const complex_t IT_0105 = lpp_121*U_utR_12;
    const complex_t IT_0106 = lpp_221*U_utR_22;
    const complex_t IT_0107 = (complex_t{0, 1})*(IT_0104 + IT_0105 + IT_0106);
    const complex_t IT_0108 = IT_0103 + IT_0107;
    const complex_t IT_0109 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_12);
    ...
    const complex_t IT_0126 = m_b*m_c*m_s*m_XX;
