        ...
        )
{
    ...
    const complex_t IT_0001 = std::conj(lpp_001)*std::conj(U_dtR_00);
    const complex_t IT_0002 = std::conj(lpp_010)*std::conj(U_dtR_00);
    const complex_t IT_0003 = std::conj(lpp_012)*std::conj(U_dtR_20);
    const complex_t IT_0004 = std::conj(lpp_021)*std::conj(U_dtR_20);
