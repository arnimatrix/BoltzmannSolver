        ...
        )
{
    ...
    const complex_t IT_0001 = std::conj(lpp_001)*std::conj(U_dtR_10);
    const complex_t IT_0002 = std::conj(lpp_002)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0013 = std::conj(lpp_001)*std::conj(U_dtR_11);
    const complex_t IT_0014 = std::conj(lpp_002)*std::conj(U_dtR_21);
    const complex_t IT_0015 = std::conj(lpp_010)*std::conj(U_dtR_11);
    const complex_t IT_0016 = std::conj(lpp_020)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0023 = std::conj(lpp_001)*std::conj(U_dtR_12);
    const complex_t IT_0024 = std::conj(lpp_002)*std::conj(U_dtR_22);
    const complex_t IT_0025 = std::conj(lpp_010)*std::conj(U_dtR_12);
    const complex_t IT_0026 = std::conj(lpp_020)*std::conj(U_dtR_22);
    ...
    const complex_t IT_0049 = m_u*m_XX*IT_0008;
