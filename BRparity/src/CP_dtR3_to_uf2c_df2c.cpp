...
complex_t CP_dtR3_to_uf2c_df2c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0000 = lpp_101*U_dtR_02;
    const complex_t IT_0001 = lpp_110*U_dtR_02;
    const complex_t IT_0002 = lpp_112*U_dtR_22;
    const complex_t IT_0003 = lpp_121*U_dtR_22;
