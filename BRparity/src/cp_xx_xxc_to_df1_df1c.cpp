        ...
        )
{
    ...
    auto const &U_dtL_00 = param.U_dtL_00;
    auto const &U_dtL_01 = param.U_dtL_01;
    auto const &U_dtL_02 = param.U_dtL_02;
    auto const &U_dtR_00 = param.U_dtR_00;
    auto const &U_dtR_01 = param.U_dtR_01;
    auto const &U_dtR_02 = param.U_dtR_02;
    const complex_t IT_0022 = gw*gwdL*U_dtL_00;
    const complex_t IT_0023 = gw*gwdL*std::conj(U_dtL_00);
    ...
    const complex_t IT_0026 = std::pow((-2)*s_24 + (complex_t{0, 1})*GdLt
      *m_dtL1 + IT_0003 + IT_0005 + -IT_0025, -1);
    const complex_t IT_0027 = (complex_t{0, 1})*IT_0024*IT_0026;
    const complex_t IT_0028 = gw*gwdL*U_dtL_01;
    const complex_t IT_0029 = gw*gwdL*std::conj(U_dtL_01);
    const complex_t IT_0030 = IT_0028*IT_0029;
    const complex_t IT_0031 = std::pow(m_dtL2, 2);
    const complex_t IT_0032 = std::pow((-2)*s_24 + (complex_t{0, 1})*GsLt
      *m_dtL2 + IT_0003 + IT_0005 + -IT_0031, -1);
    const complex_t IT_0033 = (complex_t{0, 1})*IT_0030*IT_0032;
    const complex_t IT_0034 = gw*gwdL*U_dtL_02;
    const complex_t IT_0035 = gw*gwdL*std::conj(U_dtL_02);
    const complex_t IT_0036 = IT_0034*IT_0035;
    const complex_t IT_0037 = std::pow(m_dtL3, 2);
    const complex_t IT_0038 = std::pow((-2)*s_24 + (complex_t{0, 1})*GbLt
    ...
    const complex_t IT_0000 = gw*gwdR*U_dtR_00;
    const complex_t IT_0001 = gw*gwdR*std::conj(U_dtR_00);
    const complex_t IT_0002 = IT_0000*IT_0001;
    const complex_t IT_0006 = std::pow(m_dtR1, 2);
    const complex_t IT_0007 = std::pow((-2)*s_24 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0003 + IT_0005 + -IT_0006, -1);
    const complex_t IT_0008 = (complex_t{0, 1})*IT_0002*IT_0007;
    const complex_t IT_0009 = gw*gwdR*U_dtR_01;
    const complex_t IT_0010 = gw*gwdR*std::conj(U_dtR_01);
    ...
    const complex_t IT_0015 = gw*gwdR*U_dtR_02;
    const complex_t IT_0016 = gw*gwdR*std::conj(U_dtR_02);
    const complex_t IT_0017 = IT_0015*IT_0016;
    const complex_t IT_0018 = std::pow(m_dtR3, 2);
    const complex_t IT_0019 = std::pow((-2)*s_24 + (complex_t{0, 1})*GbRt
    ...
    const complex_t IT_0054 = std::pow((-2)*s_25 + (complex_t{0, 1})*GdLt
      *m_dtL1 + IT_0003 + IT_0005 + -IT_0025, -1);
    const complex_t IT_0055 = (complex_t{0, 1})*IT_0024*IT_0054;
    const complex_t IT_0056 = std::pow((-2)*s_25 + (complex_t{0, 1})*GsLt
      *m_dtL2 + IT_0003 + IT_0005 + -IT_0031, -1);
    const complex_t IT_0057 = (complex_t{0, 1})*IT_0030*IT_0056;
    const complex_t IT_0058 = std::pow((-2)*s_25 + (complex_t{0, 1})*GbLt
      *m_dtL3 + IT_0003 + IT_0005 + -IT_0037, -1);
    const complex_t IT_0059 = (complex_t{0, 1})*IT_0036*IT_0058;
    const complex_t IT_0060 = IT_0055 + IT_0057 + IT_0059;
    const complex_t IT_0045 = std::pow((-2)*s_25 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0003 + IT_0005 + -IT_0006, -1);
    const complex_t IT_0046 = (complex_t{0, 1})*IT_0002*IT_0045;
    const complex_t IT_0047 = std::pow((-2)*s_25 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0003 + IT_0005 + -IT_0012, -1);
    const complex_t IT_0048 = (complex_t{0, 1})*IT_0011*IT_0047;
    const complex_t IT_0049 = std::pow((-2)*s_25 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0003 + IT_0005 + -IT_0018, -1);
