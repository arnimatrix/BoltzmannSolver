        ...
        )
{
    ...
    const complex_t IT_0080 = lpp_201*U_dtR_00;
    const complex_t IT_0081 = lpp_210*U_dtR_00;
    const complex_t IT_0082 = lpp_212*U_dtR_20;
    const complex_t IT_0083 = lpp_221*U_dtR_20;
    ...
    const complex_t IT_0089 = lpp_201*U_dtR_01;
    const complex_t IT_0090 = lpp_210*U_dtR_01;
    const complex_t IT_0091 = lpp_212*U_dtR_21;
    const complex_t IT_0092 = lpp_221*U_dtR_21;
    ...
    const complex_t IT_0098 = lpp_201*U_dtR_02;
    const complex_t IT_0099 = lpp_210*U_dtR_02;
    const complex_t IT_0100 = lpp_212*U_dtR_22;
    const complex_t IT_0101 = lpp_221*U_dtR_22;
