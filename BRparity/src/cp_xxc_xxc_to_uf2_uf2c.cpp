...
complex_t CP_XXc_XXc_to_uf2_uf2c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0026 = std::pow((-2)*s_25 + (complex_t{0, 1})*GcLt
    ...
    const complex_t IT_0032 = std::pow((-2)*s_25 + (complex_t{0, 1})*GuLt
    ...
    const complex_t IT_0054 = std::pow((-2)*s_24 + (complex_t{0, 1})*GcLt
      *m_utL2 + IT_0003 + IT_0005 + -IT_0025, -1);
    const complex_t IT_0055 = (complex_t{0, 1})*IT_0024*IT_0054;
    const complex_t IT_0056 = std::pow((-2)*s_24 + (complex_t{0, 1})*GuLt
      *m_utL1 + IT_0003 + IT_0005 + -IT_0031, -1);
