        ...
        )
{
    ...
    const complex_t IT_0044 = std::pow(m_c, 2);
    ...
    const complex_t IT_0080 = std::pow(2*s_23 + (complex_t{0, 1})*GdRt*m_dtR1 
      + IT_0007 + -IT_0009 + IT_0044 + reg_prop, -1);
    ...
    const complex_t IT_0089 = std::pow(2*s_23 + (complex_t{0, 1})*GsRt*m_dtR2 
      + IT_0007 + -IT_0019 + IT_0044 + reg_prop, -1);
    ...
    const complex_t IT_0098 = std::pow(2*s_23 + (complex_t{0, 1})*GbRt*m_dtR3 
      + IT_0007 + -IT_0029 + IT_0044 + reg_prop, -1);
