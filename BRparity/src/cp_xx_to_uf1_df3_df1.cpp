...
complex_t CP_XX_to_uf1_df3_df1(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0131 = IT_0039*(12*std::conj(IT_0039)*IT_0040 + (-6)
      *std::conj(IT_0087)*(IT_0040 + IT_0091) + 6*std::conj(IT_0126)*IT_0128) +
       IT_0126*(12*IT_0089*std::conj(IT_0126) + 6*std::conj(IT_0039)*IT_0128 +
       std::conj(IT_0087)*IT_0130) + IT_0087*(12*std::conj(IT_0087)*IT_0088 + (
      -6)*std::conj(IT_0039)*(IT_0040 + IT_0091) + std::conj(IT_0126)*IT_0130);
    return IT_0131;
}
