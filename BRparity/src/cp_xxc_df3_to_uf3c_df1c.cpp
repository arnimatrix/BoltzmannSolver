        ...
        )
{
    ...
    const complex_t IT_0041 = lpp_202*U_dtR_00;
    const complex_t IT_0042 = lpp_212*U_dtR_10;
    const complex_t IT_0043 = IT_0041 + IT_0042;
    const complex_t IT_0044 = lpp_220*U_dtR_00;
    const complex_t IT_0045 = lpp_221*U_dtR_10;
    const complex_t IT_0046 = -IT_0044 + -IT_0045;
    const complex_t IT_0047 = IT_0043 + IT_0046;
    const complex_t IT_0048 = gw*gwdR*std::conj(U_dtR_00);
    ...
    const complex_t IT_0056 = lpp_220*U_dtR_02;
    const complex_t IT_0057 = lpp_221*U_dtR_12;
    const complex_t IT_0058 = -IT_0056 + -IT_0057;
    const complex_t IT_0059 = IT_0055 + IT_0058;
    const complex_t IT_0060 = gw*gwdR*std::conj(U_dtR_02);
    const complex_t IT_0061 = IT_0059*IT_0060;
    const complex_t IT_0062 = std::pow((-2)*s_25 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0011 + -IT_0036 + IT_0050, -1);
    const complex_t IT_0063 = (complex_t{0, 1})*IT_0061*IT_0062;
    const complex_t IT_0064 = IT_0052 + IT_0063;
    const complex_t IT_0065 = lpp_202*U_dtR_01;
    const complex_t IT_0066 = lpp_212*U_dtR_11;
    const complex_t IT_0067 = IT_0065 + IT_0066;
    const complex_t IT_0068 = lpp_220*U_dtR_01;
    const complex_t IT_0069 = lpp_221*U_dtR_11;
    const complex_t IT_0070 = -IT_0068 + -IT_0069;
    const complex_t IT_0071 = IT_0067 + IT_0070;
    const complex_t IT_0072 = gw*gwdR*std::conj(U_dtR_01);
    const complex_t IT_0073 = IT_0071*IT_0072;
    const complex_t IT_0074 = std::pow((-2)*s_25 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0011 + -IT_0024 + IT_0050, -1);
    const complex_t IT_0075 = (complex_t{0, 1})*IT_0073*IT_0074;
    const complex_t IT_0076 = -IT_0075;
    const complex_t IT_0077 = s_25*s_34;
    const complex_t IT_0078 = s_24*s_35;
    const complex_t IT_0079 = -IT_0078;
    const complex_t IT_0080 = IT_0040 + IT_0077 + IT_0079;
    ...
    const complex_t IT_0128 = -IT_0077;
    const complex_t IT_0129 = IT_0040 + IT_0128;
    const complex_t IT_0130 = IT_0078 + IT_0129;
    const complex_t IT_0131 = IT_0079 + IT_0129;
    const complex_t IT_0132 = -std::conj(IT_0076);
    const complex_t IT_0133 = (-0.5)*std::conj(IT_0127)*IT_0131;
    const complex_t IT_0134 = 2*IT_0039*(std::conj(IT_0039)*IT_0040 + (-0.5)*
      (std::conj(IT_0064) + -std::conj(IT_0076))*IT_0080 + 0.5*std::conj(IT_0127
      )*IT_0130) + 2*IT_0127*(IT_0078*std::conj(IT_0127) + 0.5*std::conj(IT_0039
      )*IT_0130 + (-0.5)*IT_0131*(std::conj(IT_0064) + IT_0132)) + -(IT_0064 + 
      -IT_0076)*(std::conj(IT_0039)*IT_0080 + (-2)*IT_0077*(std::conj(IT_0064) +
       IT_0132) + (-2)*IT_0133);
    return IT_0134;
}
