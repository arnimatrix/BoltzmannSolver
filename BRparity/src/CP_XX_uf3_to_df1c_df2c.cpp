        ...
        )
{
    ...
    const complex_t IT_0047 = m_d*m_s*m_t*m_XX;
    ...
    const complex_t IT_0052 = lpp_210*U_dtR_10;
    const complex_t IT_0053 = lpp_220*U_dtR_20;
    const complex_t IT_0054 = (complex_t{0, -1})*(IT_0050 + IT_0051 + -IT_0052
       + -IT_0053);
    const complex_t IT_0055 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_10);
    const complex_t IT_0056 = IT_0054*IT_0055;
    const complex_t IT_0057 = std::pow(m_t, 2);
    ...
    const complex_t IT_0060 = lpp_201*U_dtR_11;
    const complex_t IT_0061 = lpp_202*U_dtR_21;
    const complex_t IT_0062 = lpp_210*U_dtR_11;
    const complex_t IT_0063 = lpp_220*U_dtR_21;
    const complex_t IT_0064 = (complex_t{0, -1})*(IT_0060 + IT_0061 + -IT_0062
       + -IT_0063);
    const complex_t IT_0065 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_11);
    ...
    const complex_t IT_0069 = lpp_201*U_dtR_12;
    const complex_t IT_0070 = lpp_202*U_dtR_22;
    const complex_t IT_0071 = lpp_210*U_dtR_12;
    const complex_t IT_0072 = lpp_220*U_dtR_22;
    const complex_t IT_0073 = (complex_t{0, -1})*(IT_0069 + IT_0070 + -IT_0071
       + -IT_0072);
    const complex_t IT_0074 = (complex_t{0, -1})*gw*gwdR*std::conj(U_dtR_12);
    ...
    const complex_t IT_0091 = lpp_010*U_utR_00;
    const complex_t IT_0092 = lpp_110*U_utR_10;
    const complex_t IT_0093 = lpp_210*U_utR_20;
    const complex_t IT_0094 = (complex_t{0, 1})*(IT_0091 + IT_0092 + IT_0093);
    const complex_t IT_0095 = IT_0090 + IT_0094;
    const complex_t IT_0096 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_20);
    ...
    const complex_t IT_0101 = lpp_001*U_utR_01;
    const complex_t IT_0102 = lpp_101*U_utR_11;
    const complex_t IT_0103 = lpp_201*U_utR_21;
    const complex_t IT_0104 = (complex_t{0, 1})*(IT_0101 + IT_0102 + IT_0103);
    const complex_t IT_0105 = -IT_0104;
    const complex_t IT_0106 = lpp_010*U_utR_01;
    const complex_t IT_0107 = lpp_110*U_utR_11;
    const complex_t IT_0108 = lpp_210*U_utR_21;
    const complex_t IT_0109 = (complex_t{0, 1})*(IT_0106 + IT_0107 + IT_0108);
    const complex_t IT_0110 = IT_0105 + IT_0109;
    const complex_t IT_0111 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_21);
    ...
    const complex_t IT_0116 = lpp_001*U_utR_02;
    const complex_t IT_0117 = lpp_101*U_utR_12;
    const complex_t IT_0118 = lpp_201*U_utR_22;
    const complex_t IT_0119 = (complex_t{0, 1})*(IT_0116 + IT_0117 + IT_0118);
    const complex_t IT_0120 = -IT_0119;
    const complex_t IT_0121 = lpp_010*U_utR_02;
    const complex_t IT_0122 = lpp_110*U_utR_12;
    const complex_t IT_0123 = lpp_210*U_utR_22;
    const complex_t IT_0124 = (complex_t{0, 1})*(IT_0121 + IT_0122 + IT_0123);
    const complex_t IT_0125 = IT_0120 + IT_0124;
    const complex_t IT_0126 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_22);
