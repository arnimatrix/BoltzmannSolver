...
complex_t CP_XX_to_uf3_df2_df3(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0050 = std::conj(lpp_202)*std::conj(U_dtR_00);
    const complex_t IT_0051 = std::conj(lpp_212)*std::conj(U_dtR_10);
    const complex_t IT_0052 = IT_0050 + IT_0051;
    const complex_t IT_0053 = std::conj(lpp_220)*std::conj(U_dtR_00);
    const complex_t IT_0054 = std::conj(lpp_221)*std::conj(U_dtR_10);
    ...
    const complex_t IT_0063 = std::conj(lpp_202)*std::conj(U_dtR_01);
    const complex_t IT_0064 = std::conj(lpp_212)*std::conj(U_dtR_11);
    const complex_t IT_0065 = IT_0063 + IT_0064;
    const complex_t IT_0066 = std::conj(lpp_220)*std::conj(U_dtR_01);
    const complex_t IT_0067 = std::conj(lpp_221)*std::conj(U_dtR_11);
    ...
    const complex_t IT_0075 = std::conj(lpp_202)*std::conj(U_dtR_02);
    const complex_t IT_0076 = std::conj(lpp_212)*std::conj(U_dtR_12);
    const complex_t IT_0077 = IT_0075 + IT_0076;
    const complex_t IT_0078 = std::conj(lpp_220)*std::conj(U_dtR_02);
    const complex_t IT_0079 = std::conj(lpp_221)*std::conj(U_dtR_12);
    ...
    const complex_t IT_0093 = std::conj(lpp_201)*std::conj(U_dtR_00);
    const complex_t IT_0094 = std::conj(lpp_221)*std::conj(U_dtR_20);
    const complex_t IT_0095 = IT_0093 + IT_0094;
    const complex_t IT_0096 = std::conj(lpp_210)*std::conj(U_dtR_00);
    const complex_t IT_0097 = std::conj(lpp_212)*std::conj(U_dtR_20);
    ...
    const complex_t IT_0103 = std::pow((-2)*s_25 + (complex_t{0, 1})*GdRt
      *m_dtR1 + IT_0014 + -IT_0060 + IT_0102, -1);
    const complex_t IT_0104 = (complex_t{0, 1})*IT_0101*IT_0103;
    const complex_t IT_0105 = std::conj(lpp_201)*std::conj(U_dtR_01);
    const complex_t IT_0106 = std::conj(lpp_221)*std::conj(U_dtR_21);
    const complex_t IT_0107 = IT_0105 + IT_0106;
    const complex_t IT_0108 = std::conj(lpp_210)*std::conj(U_dtR_01);
    const complex_t IT_0109 = std::conj(lpp_212)*std::conj(U_dtR_21);
    ...
    const complex_t IT_0114 = std::pow((-2)*s_25 + (complex_t{0, 1})*GsRt
      *m_dtR2 + IT_0014 + -IT_0072 + IT_0102, -1);
    const complex_t IT_0115 = (complex_t{0, 1})*IT_0113*IT_0114;
    const complex_t IT_0116 = std::conj(lpp_201)*std::conj(U_dtR_02);
    const complex_t IT_0117 = std::conj(lpp_221)*std::conj(U_dtR_22);
    const complex_t IT_0118 = IT_0116 + IT_0117;
    const complex_t IT_0119 = std::conj(lpp_210)*std::conj(U_dtR_02);
    const complex_t IT_0120 = std::conj(lpp_212)*std::conj(U_dtR_22);
    ...
    const complex_t IT_0125 = std::pow((-2)*s_25 + (complex_t{0, 1})*GbRt
      *m_dtR3 + IT_0014 + -IT_0084 + IT_0102, -1);
    const complex_t IT_0126 = (complex_t{0, 1})*IT_0124*IT_0125;
    const complex_t IT_0127 = -IT_0104 + -IT_0115 + -IT_0126;
    const complex_t IT_0128 = 6*IT_0049 + (-6)*IT_0088 + 6*IT_0089;
    const complex_t IT_0129 = -IT_0088;
    ...
    const complex_t IT_0132 = IT_0048*(12*std::conj(IT_0048)*IT_0049 + 6
      *std::conj(IT_0087)*IT_0092 + std::conj(IT_0127)*IT_0128) + IT_0127*(12
      *IT_0089*std::conj(IT_0127) + std::conj(IT_0048)*IT_0128 + std::conj
      (IT_0087)*IT_0131) + IT_0087*(12*std::conj(IT_0087)*IT_0088 + 6*std::conj
      (IT_0048)*IT_0092 + std::conj(IT_0127)*IT_0131);
    return IT_0132;
}
