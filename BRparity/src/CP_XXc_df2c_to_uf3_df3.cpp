...
complex_t CP_XXc_df2c_to_uf3_df3(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0048 = std::pow(2*s_12 + (complex_t{0, 1})*GdRt*m_dtR1 
    ...
    const complex_t IT_0058 = std::pow(2*s_12 + (complex_t{0, 1})*GsRt*m_dtR2 
    ...
    const complex_t IT_0068 = std::pow(2*s_12 + (complex_t{0, 1})*GbRt*m_dtR3 
      + IT_0010 + IT_0046 + -IT_0067 + reg_prop, -1);
    const complex_t IT_0069 = (complex_t{0, 1})*IT_0066*IT_0068;
    const complex_t IT_0070 = -IT_0049 + -IT_0059 + -IT_0069;
    ...
    const complex_t IT_0106 = m_b*m_s*m_t*m_XX;
    ...
    const complex_t IT_0111 = 0.25*IT_0013 + 0.25*IT_0025 + 0.25*IT_0037;
    const complex_t IT_0112 = 0.25*IT_0079 + 0.25*IT_0088 + 0.25*IT_0097;
    const complex_t IT_0113 = IT_0111*std::conj(IT_0112);
    const complex_t IT_0114 = std::conj(IT_0111)*IT_0112;
    const complex_t IT_0115 = IT_0112*std::conj(IT_0112);
    const complex_t IT_0116 = IT_0111*std::conj(IT_0111);
    const complex_t IT_0117 = IT_0113 + IT_0114 + IT_0115 + IT_0116;
    return 2*(IT_0038 + -IT_0070 + IT_0098)*(std::conj(IT_0038) + -std::conj
      (IT_0070) + std::conj(IT_0098))*IT_0099 + (IT_0108 + IT_0110)*IT_0117;
}
