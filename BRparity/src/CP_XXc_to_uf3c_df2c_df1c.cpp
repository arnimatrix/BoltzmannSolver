...
complex_t CP_XXc_to_uf3c_df2c_df1c(
        param_t const &param
        )
{
    clearcache();
    ...
    const complex_t IT_0012 = lpp_201*U_dtR_11;
    const complex_t IT_0013 = lpp_202*U_dtR_21;
    const complex_t IT_0014 = lpp_210*U_dtR_11;
    const complex_t IT_0015 = lpp_220*U_dtR_21;
    ...
    const complex_t IT_0022 = lpp_201*U_dtR_12;
    const complex_t IT_0023 = lpp_202*U_dtR_22;
    const complex_t IT_0024 = lpp_210*U_dtR_12;
    const complex_t IT_0025 = lpp_220*U_dtR_22;
    ...
    const complex_t IT_0034 = (-0.25)*IT_0011 + (-0.25)*IT_0021 + (-0.25)
      *IT_0031;
    ...
    const complex_t IT_0043 = lpp_201*U_dtR_00;
    const complex_t IT_0044 = lpp_210*U_dtR_00;
    const complex_t IT_0045 = lpp_212*U_dtR_20;
    const complex_t IT_0046 = lpp_221*U_dtR_20;
    ...
    const complex_t IT_0050 = std::pow(m_t, 2);
    const complex_t IT_0051 = std::pow(2*s_23 + (complex_t{0, 1})*GdRt*m_dtR1 
      + IT_0007 + -IT_0009 + IT_0050 + reg_prop, -1);
    const complex_t IT_0052 = (complex_t{0, 1})*IT_0049*IT_0051;
    const complex_t IT_0053 = lpp_201*U_dtR_01;
    const complex_t IT_0054 = lpp_210*U_dtR_01;
    const complex_t IT_0055 = lpp_212*U_dtR_21;
    const complex_t IT_0056 = lpp_221*U_dtR_21;
    ...
    const complex_t IT_0060 = std::pow(2*s_23 + (complex_t{0, 1})*GsRt*m_dtR2 
      + IT_0007 + -IT_0019 + IT_0050 + reg_prop, -1);
    const complex_t IT_0061 = (complex_t{0, 1})*IT_0059*IT_0060;
    const complex_t IT_0062 = lpp_201*U_dtR_02;
    const complex_t IT_0063 = lpp_210*U_dtR_02;
    const complex_t IT_0064 = lpp_212*U_dtR_22;
    ...
    const complex_t IT_0069 = std::pow(2*s_23 + (complex_t{0, 1})*GbRt*m_dtR3 
      + IT_0007 + -IT_0029 + IT_0050 + reg_prop, -1);
    const complex_t IT_0070 = (complex_t{0, 1})*IT_0068*IT_0069;
    const complex_t IT_0071 = (-0.25)*IT_0052 + (-0.25)*IT_0061 + (-0.25)
      *IT_0070;
    const complex_t IT_0072 = 0.25*IT_0052 + 0.25*IT_0061 + 0.25*IT_0070;
    ...
    const complex_t IT_0077 = lpp_001*U_utR_00;
    const complex_t IT_0078 = lpp_101*U_utR_10;
    const complex_t IT_0079 = lpp_201*U_utR_20;
    const complex_t IT_0080 = (complex_t{0, 1})*(IT_0077 + IT_0078 + IT_0079);
    const complex_t IT_0081 = -IT_0080;
    const complex_t IT_0082 = lpp_010*U_utR_00;
    const complex_t IT_0083 = lpp_110*U_utR_10;
    const complex_t IT_0084 = lpp_210*U_utR_20;
    const complex_t IT_0085 = (complex_t{0, 1})*(IT_0082 + IT_0083 + IT_0084);
    const complex_t IT_0086 = IT_0081 + IT_0085;
    const complex_t IT_0087 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_20);
    ...
    const complex_t IT_0090 = std::pow((-2)*s_12 + (complex_t{0, 1})*GuRt
      *m_utR1 + IT_0008 + IT_0050 + -IT_0089 + reg_prop, -1);
    const complex_t IT_0091 = (complex_t{0, 1})*IT_0088*IT_0090;
    const complex_t IT_0092 = lpp_001*U_utR_01;
    const complex_t IT_0093 = lpp_101*U_utR_11;
    const complex_t IT_0094 = lpp_201*U_utR_21;
    const complex_t IT_0095 = (complex_t{0, 1})*(IT_0092 + IT_0093 + IT_0094);
    const complex_t IT_0096 = -IT_0095;
    const complex_t IT_0097 = lpp_010*U_utR_01;
    const complex_t IT_0098 = lpp_110*U_utR_11;
    const complex_t IT_0099 = lpp_210*U_utR_21;
    const complex_t IT_0100 = (complex_t{0, 1})*(IT_0097 + IT_0098 + IT_0099);
    const complex_t IT_0101 = IT_0096 + IT_0100;
    const complex_t IT_0102 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_21);
    ...
    const complex_t IT_0105 = std::pow((-2)*s_12 + (complex_t{0, 1})*GcRt
      *m_utR2 + IT_0008 + IT_0050 + -IT_0104 + reg_prop, -1);
    const complex_t IT_0106 = (complex_t{0, 1})*IT_0103*IT_0105;
    const complex_t IT_0107 = lpp_001*U_utR_02;
    const complex_t IT_0108 = lpp_101*U_utR_12;
    const complex_t IT_0109 = lpp_201*U_utR_22;
    const complex_t IT_0110 = (complex_t{0, 1})*(IT_0107 + IT_0108 + IT_0109);
    const complex_t IT_0111 = -IT_0110;
    const complex_t IT_0112 = lpp_010*U_utR_02;
    const complex_t IT_0113 = lpp_110*U_utR_12;
    const complex_t IT_0114 = lpp_210*U_utR_22;
    const complex_t IT_0115 = (complex_t{0, 1})*(IT_0112 + IT_0113 + IT_0114);
    const complex_t IT_0116 = IT_0111 + IT_0115;
    const complex_t IT_0117 = (complex_t{0, -1})*gw*gwuR*std::conj(U_utR_22);
    ...
    const complex_t IT_0120 = std::pow((-2)*s_12 + (complex_t{0, 1})*GtRt
      *m_utR3 + IT_0008 + IT_0050 + -IT_0119 + reg_prop, -1);
    ...
    const complex_t IT_0124 = (-768)*IT_0035;
    const complex_t IT_0125 = (-768)*IT_0037;
    const complex_t IT_0126 = 384*IT_0074;
    const complex_t IT_0127 = IT_0124 + IT_0125 + IT_0126;
    const complex_t IT_0128 = m_d*m_s*m_t*m_XX;
    const complex_t IT_0129 = (-1152)*IT_0128;
    const complex_t IT_0130 = IT_0127 + IT_0129;
    const complex_t IT_0131 = 768*IT_0035;
    const complex_t IT_0132 = 768*IT_0037;
    const complex_t IT_0133 = (-384)*IT_0074;
    const complex_t IT_0134 = IT_0131 + IT_0132 + IT_0133;
    const complex_t IT_0135 = 1152*IT_0128;
    const complex_t IT_0136 = IT_0134 + IT_0135;
    const complex_t IT_0137 = std::conj(IT_0032)*IT_0039;
    const complex_t IT_0138 = IT_0127 + IT_0135;
    const complex_t IT_0139 = IT_0039*IT_0076;
    const complex_t IT_0140 = IT_0039*std::conj(IT_0076);
    const complex_t IT_0141 = std::conj(IT_0032)*IT_0042;
    const complex_t IT_0142 = IT_0033*IT_0042;
    const complex_t IT_0143 = IT_0034*IT_0042;
    const complex_t IT_0144 = std::conj(IT_0032)*IT_0123;
    const complex_t IT_0145 = std::conj(IT_0033)*IT_0042;
    const complex_t IT_0146 = std::conj(IT_0034)*IT_0042;
    const complex_t IT_0147 = IT_0032*((std::conj(IT_0033) + std::conj(IT_0034
      ...
      (IT_0076) + std::conj(IT_0122))*IT_0123) + IT_0034*(std::conj(IT_0072)
      *IT_0130 + std::conj(IT_0034)*IT_0136 + IT_0137) + IT_0033*(std::conj
      (IT_0033)*(IT_0129 + IT_0134) + IT_0137 + std::conj(IT_0071)*IT_0138) +
       IT_0073*IT_0139 + IT_0072*(std::conj(IT_0034)*IT_0130 + std::conj(IT_0072
      )*IT_0136 + IT_0140 + IT_0141) + IT_0071*(std::conj(IT_0071)*(IT_0129 +
       IT_0134) + std::conj(IT_0033)*IT_0138 + IT_0140 + IT_0141) + std::conj
      (IT_0076)*(IT_0142 + IT_0143) + std::conj(IT_0122)*(IT_0039*(IT_0071 +
       IT_0072) + IT_0075*IT_0076 + IT_0142 + IT_0143) + IT_0076*(IT_0075
      *std::conj(IT_0076) + IT_0144 + IT_0145 + IT_0146) + IT_0122*(IT_0039*
      (std::conj(IT_0071) + std::conj(IT_0072)) + IT_0075*(std::conj(IT_0076) +
       std::conj(IT_0122)) + IT_0144 + IT_0145 + IT_0146);
    return IT_0147;
}
