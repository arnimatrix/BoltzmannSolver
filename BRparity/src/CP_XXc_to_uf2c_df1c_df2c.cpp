        ...
        )
{
    ...
    const complex_t IT_0034 = lpp_101*U_dtR_10;
    const complex_t IT_0035 = lpp_102*U_dtR_20;
    const complex_t IT_0036 = lpp_110*U_dtR_10;
    const complex_t IT_0037 = lpp_120*U_dtR_20;
    ...
    const complex_t IT_0044 = lpp_101*U_dtR_11;
    const complex_t IT_0045 = lpp_102*U_dtR_21;
    const complex_t IT_0046 = lpp_110*U_dtR_11;
    const complex_t IT_0047 = lpp_120*U_dtR_21;
    ...
    const complex_t IT_0053 = lpp_101*U_dtR_12;
    const complex_t IT_0054 = lpp_102*U_dtR_22;
    const complex_t IT_0055 = lpp_110*U_dtR_12;
    const complex_t IT_0056 = lpp_120*U_dtR_22;
    ...
    const complex_t IT_0069 = lpp_001*U_utR_00;
    const complex_t IT_0070 = lpp_101*U_utR_10;
    const complex_t IT_0071 = lpp_201*U_utR_20;
    const complex_t IT_0072 = (complex_t{0, 1})*(IT_0069 + IT_0070 + IT_0071);
    const complex_t IT_0073 = -IT_0072;
    const complex_t IT_0074 = lpp_010*U_utR_00;
    const complex_t IT_0075 = lpp_110*U_utR_10;
    const complex_t IT_0076 = lpp_210*U_utR_20;
    ...
    const complex_t IT_0084 = lpp_001*U_utR_01;
    const complex_t IT_0085 = lpp_101*U_utR_11;
    const complex_t IT_0086 = lpp_201*U_utR_21;
    const complex_t IT_0087 = (complex_t{0, 1})*(IT_0084 + IT_0085 + IT_0086);
    const complex_t IT_0088 = -IT_0087;
    const complex_t IT_0089 = lpp_010*U_utR_01;
    const complex_t IT_0090 = lpp_110*U_utR_11;
    const complex_t IT_0091 = lpp_210*U_utR_21;
    ...
    const complex_t IT_0104 = lpp_010*U_utR_02;
    const complex_t IT_0105 = lpp_110*U_utR_12;
    const complex_t IT_0106 = lpp_210*U_utR_22;
    ...
    const complex_t IT_0126 = m_c*m_d*m_s*m_XX;
