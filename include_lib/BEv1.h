...
const std::array<std::string , 12> pnthSM = {"utR1","utR1c","utR2","utR2c","utR3","utR3c","dtR1","dtR1c","dtR2","dtR2c","dtR3","dtR3c"
};

const std::array<std::string , 2> pXSM = {
    "XX","XXc"
};

const std::array<std::string , 12> pthSM = {
    "uf1","uf1c","uf2","uf2c","uf3","uf3c","df1","df1c","df2","df2c","df3","df3c"
};

const std::array<pair <std::string,double> , 14> chB = {
    std::make_pair("XX",0.),
    std::make_pair("XXc",0.),
...
const std::array<pair <std::string,double> , 20> chSM = {
    std::make_pair("XX",0.),
    std::make_pair("XXc",0.),
...
const std::array<pair <std::string,double> , 7> gptl = {
    std::make_pair("XX",2.),
    std::make_pair("uf1",6.),
    std::make_pair("uf2",6.),
    std::make_pair("uf3",6.),
